...
if (isset($_POST['savesettings'])) {
    $PROTOTYPE_PREF['prototype_active'] = (int)$_POST['prototype_active'];
    $PROTOTYPE_PREF['prototype_mini'] = (int)$_POST['prototype_mini'];
    $PROTOTYPE_PREF['prototype_lb'] = (int)$_POST['prototype_lb'];
...
$prototype_text .= "
		<tr>
			<td class='forumheader3' style='width:30%;'>" . PROTOTYPE_C20 . "</td>
			<td class='forumheader3'>
				<input type='radio' name='prototype_lb' id='prototype_lb0' class='tbox' value='0' " . ($PROTOTYPE_PREF['prototype_lb'] == 0?'checked="checked"':'') . "' style='border:0px;' /><label for='prototype_lb0' > " . PROTOTYPE_C21 . "</label><br />
				<input type='radio' name='prototype_lb' id='prototype_lb1' class='tbox' value='1' " . ($PROTOTYPE_PREF['prototype_lb'] == 1?'checked="checked"':'') . "' style='border:0px;' /><label for='prototype_lb1' > " . PROTOTYPE_C22 . "</label>
			</td>
		</tr>";
$prototype_text .= "
		<tr>
