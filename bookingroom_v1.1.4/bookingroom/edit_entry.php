...
?>
<TR>
 <TD CLASS=CR><? print $pref['mrbs_userdef1']; ?></TD>
 <TD CLASS=CL><INPUT TYPE=checkbox NAME="mrbs_userdef1" value = '1'<? if($userdef1 == 1) print " checked";?>></TD>
</TR>
<?
...
?>
<TR>
 <TD CLASS=CR><? print $pref['mrbs_userdef2']; ?></TD>
 <TD CLASS=CL><INPUT TYPE=checkbox NAME="mrbs_userdef2" value = '1'<? if($userdef2 == 1) print " checked";?>></TD>
</TR>
<?
}
?>
...
?>
<TR>
 <TD CLASS=CR><? print $pref['mrbs_userdef3']; ?></TD>
 <TD CLASS=CL><INPUT TYPE=checkbox NAME="mrbs_userdef3" value = '1'<? if($userdef1 == 3) print " checked";?> ></TD>
</TR>
<?
}
?>
...
?>
<TR>
 <TD CLASS=CR><? print $pref['mrbs_userdef4']; ?></TD>
 <TD CLASS=CL><INPUT TYPE=checkbox NAME="mrbs_userdef4" value = '1'<? if($userdef1 == 4) print " checked";?> ></TD>
</TR>
<?
}
?>
...
?>
<TR>
 <TD CLASS=CR><? print $pref['mrbs_userdef5']; ?></TD>
 <TD CLASS=CL><INPUT TYPE=checkbox NAME="mrbs_userdef5"  value = '1'<? if($userdef5 == 1) print " checked";?>></TD>
</TR>
<?
}
?>
