...
if ( $pview != 1 ) {
   echo "<table width=\"97%\"><tr><td width=\"5%\">";
...
else
{
	...
	if ( $pview != 1 ) {
        ...
        $output = "<table width=\"95%\"><tr><td><a href=\"day.php?year=$yy&month=$ym&day=$yd&area=$area\">&lt;&lt;".get_vocab("daybefore")."</a></td>
	...
	echo "<table cellspacing=2 border=1 width=\"97%\">";
