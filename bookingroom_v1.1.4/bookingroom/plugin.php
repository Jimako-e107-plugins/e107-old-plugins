...
$eplug_url = "";
$eplug_email = "Ian.Beaver@mgeups.com";
...
$eplug_folder = "Bookingroom";

// Mane of menu item for plugin ----------------------------------------------------------------------------------
$eplug_menu_name = "MRBS";
...
$eplug_prefs = array(
	...
	"mrbs_typeI" => "",
	"mrbs_typeJ" => "",
    # can`t get this to work nder her it list them but it does not keep the informations
	"mrbs_userdef1"=>"",
	"mrbs_userdef2"=>"",
	"mrbs_userdef3"=>"",
	"mrbs_userdef4"=>"",
...
$eplug_link_url = e_PLUGIN."bookingroom/mrbs.php";
