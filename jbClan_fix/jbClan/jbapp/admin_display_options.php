                            ...
                            <tr>";
                                ...
                                <td class='forumheader3' width='50%'>
                                    ...
                                    if ($row['application_display'] == 2) {
                                     ...
                                     //$text .= "<input type='checkbox' name='attribute_application_display[]' value='".$row['attribute_id']."' checked='checked' />";                                                                     
                                        $text .= $frm->checkbox('attribute_application_display[]', $row['attribute_id'], true);
                                    } else {
                                        $text .= $frm->checkbox('attribute_application_display[]', $row['attribute_id'], false);
