                ...
                <tr>
                    <td>
                        <center>
                            ...
                            <p>
                            ".$frm->text('organization_email', $organization_email, 35, 'required=1&size=xxlarge')."
                ...
                <tr>
                    <td>
                        <center>
                            ...
                            <p>
                               ".$frm->bbarea('organization_disclaimer', $organization_disclaimer,'organization_disclaimer', '', 'small')."                             
                            </p>
                        </center>
                    </td>
                </tr>
