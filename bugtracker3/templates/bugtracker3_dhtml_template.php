...
$bt3_template_name = "DHTML";
// Template description, a bit more info about the template
$bt3_template_description = "Template incorporating dynamic HTML to display some page - supplied with Bugtracker3 by bugrain";

// ************************************************************************************************
// Page Templates
// These template variables are passed from the bugtracker3 code, they must be defined to ensure
// all Bugtracker3 pages can at least display something. Make sure they are defined as globals here, too.
...
// whole page. They are mainly used by the page templates (see above).
   ...
   $BUG3_APP_INFO = "
      <table summary='{BUG3_APP_SUMMARY}' style='width:100%;'>
         ...
         <tr>
            ...
            <td class='forumheader3'>{BUG3_APP_CATEGORY_LIST}</td>
            <td class='forumheader2'>{BUG3_LABEL_STATUS}</td>
            <td class='forumheader3'>{BUG3_APP_STATUS_LIST}</td>
         </tr>
         <tr>
            <td class='forumheader2'>{BUG3_LABEL_PRIORITY}</td>
            <td class='forumheader3'>{BUG3_APP_PRIORITY_LIST}</td>
            <td class='forumheader2'>{BUG3_LABEL_RESOLUTION}</td>
            <td class='forumheader3'>{BUG3_APP_RESOLUTION_LIST}</td>
         </tr>
      </table>
   ";
}
...
// Application chart
$sc_style['BUG3_APP_CHARTS']['pre']  = "<div class='forumheader2' style='text-align:center;'>";
...
if (!isset($BUG3_BUG)){
   $BUG3_BUG = "
      <div id='bugtracker3_details'>
         <table summary='*' style='width:100%;width:100%;cell-spacing:0px;cell-padding:0px;'>
            <tr class='forumheader'>
               <td class='indent' style='width:25%;cursor:pointer;text-align:center;'>Details</td>
               <td class='forumheader2' style='width:25%;cursor:pointer;text-align:center;' onclick='expandit(\"bugtracker3_summary\");expandit(\"bugtracker3_details\");'>Summary</td>
               <td class='forumheader2' style='width:25%;cursor:pointer;text-align:center;' onclick='expandit(\"bugtracker3_comments\");expandit(\"bugtracker3_details\");'>Comments</td>
               <td class='forumheader2' style='width:25%;cursor:pointer;text-align:center;' onclick='expandit(\"bugtracker3_developer\");expandit(\"bugtracker3_details\");'>Developer</td>
            </tr>
            <tr>
               <td colspan='4' class='forumheader3'><strong>{BUG3_BUG_ID} [{BUG3_BUG_CATEGORY_NAME}] {BUG3_BUG_SUMMARY}</strong></td>
            </tr>
         </table>
      ...
      <div id='bugtracker3_summary' style='display:none;'>
         <table summary='*' style='width:100%;cell-spacing:0px;cell-padding:0px;'>
            <tr class='forumheader'>
               <td class='forumheader2' style='width:25%;cursor:pointer;text-align:center;' onclick='expandit(\"bugtracker3_details\");expandit(\"bugtracker3_summary\");'>Details</td>
               <td class='indent' style='width:25%;cursor:pointer;text-align:center;'>Summary</td>
               <td class='forumheader2' style='width:25%;cursor:pointer;text-align:center;' onclick='expandit(\"bugtracker3_comments\");expandit(\"bugtracker3_summary\");'>Comments</td>
               <td class='forumheader2' style='width:25%;cursor:pointer;text-align:center;' onclick='expandit(\"bugtracker3_developer\");expandit(\"bugtracker3_summary\");'>Developer</td>
            </tr>
            <tr>
               <td colspan='4' class='forumheader3'><strong>{BUG3_BUG_ID} [{BUG3_BUG_CATEGORY_NAME}] {BUG3_BUG_SUMMARY}</strong></td>
            </tr>
      ...
      <div id='bugtracker3_comments' style='display:none;'>
         <table summary='*' style='width:100%;width:100%;cell-spacing:0px;cell-padding:0px;'>
            <tr class='forumheader'>
               <td class='forumheader2' style='width:25%;cursor:pointer;text-align:center;' onclick='expandit(\"bugtracker3_details\");expandit(\"bugtracker3_comments\");'>Details</td>
               <td class='forumheader2' style='width:25%;cursor:pointer;text-align:center;' onclick='expandit(\"bugtracker3_summary\");expandit(\"bugtracker3_comments\");'>Summary</td>
               <td class='indent' style='width:25%;cursor:pointer;text-align:center;'>Comments</td>
               <td class='forumheader2' style='width:25%;cursor:pointer;text-align:center;' onclick='expandit(\"bugtracker3_developer\");expandit(\"bugtracker3_comments\");'>Developer</td>
            </tr>
            <tr>
               <td colspan='4' class='forumheader3'><strong>{BUG3_BUG_ID} [{BUG3_BUG_CATEGORY_NAME}] {BUG3_BUG_SUMMARY}</strong></td>
            </tr>
      ...
      <div id='bugtracker3_developer' style='display:none;'>
         <table summary='*' style='width:100%;width:100%;cell-spacing:0px;cell-padding:0px;'>
            <tr class='forumheader'>
               <td class='forumheader2' style='width:25%;cursor:pointer;text-align:center;' onclick='expandit(\"bugtracker3_details\");expandit(\"bugtracker3_developer\");'>Details</td>
               <td class='forumheader2' style='width:25%;cursor:pointer;text-align:center;' onclick='expandit(\"bugtracker3_summary\");expandit(\"bugtracker3_developer\");'>Summary</td>
               <td class='forumheader2' style='width:25%;cursor:pointer;text-align:center;' onclick='expandit(\"bugtracker3_comments\");expandit(\"bugtracker3_developer\");'>Comments</td>
               <td class='indent' style='width:25%;cursor:pointer;text-align:center;'>Developer</td>
            </tr>
            <tr>
               <td colspan='4' class='forumheader3'><strong>{BUG3_BUG_ID} [{BUG3_BUG_CATEGORY_NAME}] {BUG3_BUG_SUMMARY}</strong></td>
            </tr>
