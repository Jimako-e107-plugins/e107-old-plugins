...
require_once("../settings/settings_teams.php");
...
if(isset($_POST['delete']))
	...
	$del_id2=$_POST['ID'];
	$message = ($sql -> db_Delete($tablename, "$primaryid='".$del_id."' ")) ? LAN_4xA_SPORTTIPPS_030 : LAN_4xA_SPORTTIPPS_031;
...
if($action == "neu")
	...
	$configtitle="<b>".LAN_4xA_SPORTTIPPS_091."</b>";
	}
/////////////////
elseif($action == "edit")
	{
	...
	$configtitle="<b>LAN_4xA_SPORTTIPPS_092</b>";	
	}
///+++++++++++++++++++++++++
else{
...
$text .= "<div style=\"text-align:center\">
 ...
 <a href='".e_SELF."?neu.0'>".LAN_4xA_SPORTTIPPS_091."</a></div>
 </form>
 <br/> 
 <br/><b>".LAN_4xA_SPORTTIPPS_060."</b><br/>
 	<div style='width:96%'>
 		<table style='width:100%' class='fborder' cellspacing='0' cellpadding='0'>
   							<tr>
								<td class='fcaption'>".LAN_4xA_SPORTTIPPS_095."</td>
								<td class='fcaption'>".LAN_4xA_SPORTTIPPS_096."</td>
								<td class='fcaption'>".LAN_4xA_SPORTTIPPS_097."</td>
...
$sql -> db_Select($tablename, "*", "".$primaryid."!=''");
    while($row = $sql-> db_Fetch())
		{
	$text .="<tr>
   				<td class='forumheader'>".$row['team_id']."</td>
   				<td class='forumheader'><img src='../img_teams/".$row['team_icon']."' alt='' title='' border='0'></td>
					<td class='forumheader'>".$row['team_name']."</td>

					<td class='forumheader' width='100'><form method='post' action='".e_SELF."' id='editform'>
															<input type='hidden' name='ID' value='".$row['team_id']."'>
															<input type='image' title='".LAN_4xA_SPORTTIPPS_025."' name='delete[kat_{$row['team_id']}]' style='vertical-align: middle' src='".$ImageDELETE['PFAD']."' onclick=\"return jsconfirm('".LAN_4xA_SPORTTIPPS_098." [".$row['team_name']."] ".LAN_4xA_SPORTTIPPS_099."')\"/> | 
	...
	$text .="<tr>".$fields_count_global."<td class='forumheader' style='text-align:center' colspan='8'><br/><br/>".LAN_4xA_SPORTTIPPS_094."<br/><br/></td></tr>";
	}
$text .= "</table>";
