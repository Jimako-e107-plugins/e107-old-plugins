...
$e_event->register("postuserset", "reviewer_postuserset");

function reviewer_postuserset($data)
{
    ...
    // make sure we have a user name
        ...
        // if we find the user in the user table then get their details
            ...
            // if the user id is greater than 0 then update the posters details
                ...
                $sql->db_Update("reviewer_reviewer", "reviewer_reviewer_postername ='" . $tp->toDB($newname) . "' where SUBSTRING_INDEX(reviewer_reviewer_postername,'.',1)='" . $row['user_id'] . "'", false);
            }
        }
    }
}
