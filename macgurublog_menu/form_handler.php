...
|
|        Modified version to use with BLOG Engine by MacGuru
+---------------------------------------------------------------+
*/
class form_mgb{
...
// --------------------------------- Color Selector --------------------------------
	case "color":
                            ...
                            $ret = Color_Select_mgb($fieldname,$presetvalue);
...
function Color_Select_mgb($field,$dbvalue){
