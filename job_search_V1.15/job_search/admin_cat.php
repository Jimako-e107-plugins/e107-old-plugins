...
if ($jobsch_action == 'update')
{
    ...
    if ($jobsch_id == 0)
    {
		...
		'" . $tp->toDB($_POST['jobsch_caticon']) . "',0";
...
<input type='hidden' value='$jobsch_id' name='jobsch_id' />
		...
		<tr><td colspan='2' class='fcaption'>" . JOBSCH_A172 . "</td></tr>
		$jobsch_msg
		...
		<tr><td colspan='2' class='forumheader2'><input type='submit' name='submits' value='" . JOBSCH_A24 . "' class='button' /></td></tr>
