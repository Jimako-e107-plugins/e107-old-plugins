...
$text1 .= "
<b><a style='cursor:hand; cursor:pointer; text-decoration:none;' href='admin_new.php'>>> Set New MOTM <<</a></b>";
} else {
 $text1 .="
<a style='cursor:hand; cursor:pointer; text-decoration:none;' href='admin_new.php'>Set New MOTM</a>";}
...
$text1 .= "
<b><a style='cursor:hand; cursor:pointer; text-decoration:none;' href='admin_edit.php'>>> Edit MOTM <<</a></b>";
} else {
 $text1 .="
<a style='cursor:hand; cursor:pointer; text-decoration:none;' href='admin_edit.php'>Edit MOTM</a>";}
...
$text1 .= "
<b><a style='cursor:hand; cursor:pointer; text-decoration:none;' href='admin_vupdate.php'>>> Check For Updates <<</a></b>";
} else {
 $text1 .="
<a style='cursor:hand; cursor:pointer; text-decoration:none;' href='admin_vupdate.php'>Check For Updates</a>";}
