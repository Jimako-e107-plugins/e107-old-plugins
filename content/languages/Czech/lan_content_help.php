...
define("CONTENT_ADMIN_HELP_1", "Nápověda: Správa obsahu");

define("CONTENT_ADMIN_HELP_ITEM_1", "<i>Pokud jste ještě nevytvořili žádnou kategorii, učiňte tak nyní na stránce <a href='".e_SELF."?cat.create'>Vytvořit kategorii</a>.</i><br /><br /><b>Kategorie</b><br />V roletové nabídce vyberte kategorii kterou chcete spravovat.<br /><br />Vybráním <i>hlavní kategorie</i> zobrazíte veškeré položky jejího obsahu.<br />Vybráním podkategorie, zobrazíte pouze její položky obsahu.<br /><br />You can also use the menu on the right to view all content items for a specified category.");
