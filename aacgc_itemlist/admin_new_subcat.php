...
$newsubcat = $_POST['item_subcat_cat'];
$newcatname = $_POST['item_subcat_name'];
$newcatdet = $_POST['item_subcat_details'];
$reason = "";
$newok = "";
...
$text .= "</div>
		...
		<input class='button' type='submit' value='Create Sub-Category'>
		</td>
        </tr>
</table>
</div>
<br>
	      ...
	      $ns -> tablerender("AACGC Item List (create sub-category)", $text);
