...
define("EVERSION_U20", "is installed yet the script says it is version");
define("EVERSION_U21", "Stable");
define("EVERSION_U22", "The version you have installed is later than that reported by the update site.");
define("EVERSION_U23", "Check the Plugin Manager for upgrades.");
// end include
