...
$recipe_posts = $sql->db_Count("recipemenu_recipes", "(*)");
if (empty($recipe_posts))
{
    $recipe_posts = 0;
} 
$text .= "<div style='padding-bottom: 2px;'><img src='" . e_PLUGIN . "recipe_menu/images/recipe_16.gif' style='width: 16px; height: 16px; vertical-align: bottom;border:0;' alt='' /> " . RCPEMENU_A84 . ": " . $recipe_posts . "</div>";
