...
|
|     $Source: /cvsroot/e107/e107_0.7/e107_plugins/my_little_shop/templates/login_menu_template.php,v $
|     $Revision: 1.6 $
...
$LOGIN_MENU_LOGGED .= "
		{LM_BULLET}
				<a href='".e_PLUGIN."my_little_shop/sites/korb_user.php'>Meine Adresse</a><br/>";

		
	//	{LM_BULLET} {LM_USERSETTINGS}<br />
	//	{LM_BULLET}	{LM_PROFILE}<br />
$LOGIN_MENU_LOGGED .= "		{LM_BULLET} {LM_LOGOUT}
	";
}
