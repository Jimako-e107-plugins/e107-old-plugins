...
$lan_file = e_LANGUAGE;
if(e_LANGUAGE=="German"){$lan_file="de";}
elseif(e_LANGUAGE=="English"){$lan_file="en";}
	...
	define("CONFIG_LOGIN_USERNAME", 'LIGA');
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../my_little_shop/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../my_little_shop');	//accept relative path only
	...
	define('CONFIG_UPLOAD_MAXSIZE', 50 * 4096 ); //by bytes
	...
	define('CONFIG_LANG_DEFAULT', (CONFIG_QUERY_STRING_ENABLE && secureFileName($lan_file) && file_exists(DIR_LANG . secureFileName($lan_file) . '.php')?secureFileName($lan_file):'en')); //change it to be your language file base name, such en
?>