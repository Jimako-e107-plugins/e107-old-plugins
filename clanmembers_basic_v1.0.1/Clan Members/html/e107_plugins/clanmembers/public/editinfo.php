...
$row = $sql->db_Fetch();
	...
	function updateFlag(obj) {
		...
		cflag.src = "images/Profile/Flags/"+obj.value+".png"
	}
...
$text .= "<form name='memberinfo' method='post' action='clanmembers.php?saveinfo' enctype=\"multipart/form-data\">";
	...
	$text .= "<tr>
			...
			$files = array();	
			$TrackDir=opendir("images/Profile/Flags");
		...
		$text .= "</select>&nbsp;<img id='cflag' src='images/Profile/Flags/$country.png'>
		</td>
	</tr>";
	...
	$text .= "<br /><input type='hidden' name='memberid' value='$memberid'>
