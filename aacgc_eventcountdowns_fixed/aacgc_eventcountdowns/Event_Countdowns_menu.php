...
$tp = e107::getParser();
$sql = e107::getDb();
include_lan(e_PLUGIN_ABS."aacgc_eventcountdowns/languages/".e_LANGUAGE.".php");
...
$sql->select("aacgc_eventcountdowns", "*", "ecds_date > ".$now." order by ecds_date asc limit 0,1");
$row = $sql->fetch();
...
$ecds_text .= "
	<tr>
		<td style='text-align:center;' class='".$themea."' colspan='2'>
			<a href='".e_PLUGIN_ABS."aacgc_eventcountdowns/Event_Details.php?".$nexteventid."'>".$tp -> toHTML($row['ecds_title'], TRUE)."</a>
			<br/>
			<small>(".$tp->toDate($row['ecds_date'], "short").")</small>
			<br/>
...
<table style='width:100%' class=''>
	<tr>
		<td style='text-align:center;' class='".$themea."'><a href='".e_PLUGIN_ABS."aacgc_eventcountdowns/Events.php'><b>".ECDS_01."</b></a></td>
	</tr>
</table>
";
...
$ecds_text .= "
	<tr>
		<td style='text-align:center; width:50%;' class='".$themea."'><a href='".e_PLUGIN_ABS."aacgc_eventcountdowns/Event_Details.php?".$row2['ecds_id']."'>".$tp -> toHTML($row2['ecds_title'], TRUE)."</a></td>
		<td style='text-align:center; width:50%;' class='".$themea."'>".$tp->toDate($row2['ecds_date'], "short")."</td>
	</tr>
";	
