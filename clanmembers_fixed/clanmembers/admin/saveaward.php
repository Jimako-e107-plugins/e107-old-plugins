...
if($filename !=""){
	...
	if($ext != "jpg" && $ext != "jpeg" && $ext != "gif" && $ext != "png"){
		...
		$sql->db_Update("clan_members_awards", "image='$awardimage' WHERE rid='$rid'");
	}
}
}

$sql->db_Update("clan_members_awards", "title='$awardtitle', description='$awarddescription' WHERE rid='$rid'");

$text = "<meta http-equiv='refresh' content='1;URL=admin_old.php?awards' />
<center><br />"._AWARDUPDATED."<br /><br /></center>";
