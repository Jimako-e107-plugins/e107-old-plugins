...
require_once(file_exists($lan_file) ? $lan_file :  e_PLUGIN."e107_league_tipp/languages/admin/Gernam.php");
...
// --------------------------------- Color Selector --------------------------------
	case "color":
                            ...
                            $ret = myColor_Select($fieldname,$presetvalue);
...
// --------------------------------- Images --------------------------------
	case "image":
        ...
        <input class='button' type ='button' style='cursor:pointer' size='30' value='".LAN_ADM_LEAGUE_TIP_1."' onclick='expandit(this)' />
...
// --------------------------------- Access table --------------------------------
	...
	case "accesstable":
                            ...
                            $ret .="<option value='0' $checked >".LAN_ADM_LEAGUE_TIP_38."</option>";
                            $checked = ($presetvalue == 252)? " selected='selected'" : "";
                            $ret .="<option value='252' $checked >".LAN_ADM_LEAGUE_TIP_39."</option>";
                            $checked = ($presetvalue == 253)? " selected='selected'" : "";
                            $ret .="<option value='253' $checked >".LAN_ADM_LEAGUE_TIP_40."</option>";
                            $checked = ($presetvalue == 254)? " selected='selected'" : "";
                            $ret .="<option value='254' $checked >".LAN_ADM_LEAGUE_TIP_41."</option>";
                            $checked = ($presetvalue == 255)? " selected='selected'" : "";
                            $ret .="<option value='255' $checked >".LAN_ADM_LEAGUE_TIP_42."</option>";
...
// --------------------------------- Datestamp Unix --------------------------------
	...
	case "datestamp":
    	                $tabmonth[1]= LAN_ADM_LEAGUE_TIP_43;//"January";
	                    $tabmonth[2]= LAN_ADM_LEAGUE_TIP_44;//"February";
	                    $tabmonth[3]= LAN_ADM_LEAGUE_TIP_45;//"March";
	                    $tabmonth[4]= LAN_ADM_LEAGUE_TIP_46;//"April";
	                    $tabmonth[5]= LAN_ADM_LEAGUE_TIP_47;//"May";
	                    $tabmonth[6]= LAN_ADM_LEAGUE_TIP_48;//"June";
	                    $tabmonth[7]= LAN_ADM_LEAGUE_TIP_49;//"July";
	                    $tabmonth[8]= LAN_ADM_LEAGUE_TIP_50;//"August";
	                    $tabmonth[9]= LAN_ADM_LEAGUE_TIP_51;//"September";
	                    $tabmonth[10]= LAN_ADM_LEAGUE_TIP_52;//"October";
	                    $tabmonth[11]= LAN_ADM_LEAGUE_TIP_53;//"November";
	                    $tabmonth[12]= LAN_ADM_LEAGUE_TIP_54;//"December";
...
elseif($type =='short') {
    	                $tabmonth[1]= LAN_ADM_LEAGUE_TIP_55;//"Jan";
	                    $tabmonth[2]= LAN_ADM_LEAGUE_TIP_56;//"Feb";
	                    $tabmonth[3]= LAN_ADM_LEAGUE_TIP_57;//"Mar";
	                    $tabmonth[4]= LAN_ADM_LEAGUE_TIP_58;//"Apr";
	                    $tabmonth[5]= LAN_ADM_LEAGUE_TIP_59;//"May";
	                    $tabmonth[6]= LAN_ADM_LEAGUE_TIP_60;//"Jun";
	                    $tabmonth[7]= LAN_ADM_LEAGUE_TIP_61;//"Jul";
	                    $tabmonth[8]= LAN_ADM_LEAGUE_TIP_62;//"Aug";
	                    $tabmonth[9]= LAN_ADM_LEAGUE_TIP_63;//"Sep";
	                    $tabmonth[10]= LAN_ADM_LEAGUE_TIP_64;//"Oct";
	                    $tabmonth[11]= LAN_ADM_LEAGUE_TIP_65;//"Nov";
	                    $tabmonth[12]= LAN_ADM_LEAGUE_TIP_66;//"Dec";
}
...
function myColor_Select($field,$dbvalue){
  ...
  $text .= "&nbsp;#<input class='tbox' type=\"text\" name=\"".$field."\" id=\"".$field."\" value=\"".$dbvalue."\" size='15' onblur=\"View('".$field."',this.value)\" />
      &nbsp;<input class='button' type='button' value='".LAN_ADM_LEAGUE_TIP_2."' onclick='expandit(this)' />";
