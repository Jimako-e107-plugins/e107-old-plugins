		...
		$sql -> db_Select("clan_teams", "*", "ORDER BY position ASC", "");
			...
			$text .= "<tr id='$tid'>
				...
				if(isset($pref['plug_installed']['clanwars'])){
					...
					$text .= "<td class='forumheader3' width='10' nowrap><input type='button' class='button' value='"._EDIT."' onclick=\"window.location='admin.php?EditTeam&tid=$tid'\">&nbsp;<input type='button' class='button' value='"._DEL."' onclick=\"DelTeam('$tid');\"></td>
				</tr>";
			}
	$text .= "</tbody>
	</table>";
