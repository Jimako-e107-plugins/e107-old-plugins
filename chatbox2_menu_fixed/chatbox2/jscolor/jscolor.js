...
//			if(document.getElementById('cb_user_font_color')){
//				document.getElementById('cb_user_font_color').value = (leadingHash?'#':'')+color
//				document.getElementById('cb_user_font_color').style.color = (leadingHash?'#':'')+color
//				document.getElementById('cb_user_font_color').style.backgroundColor = (leadingHash?'#':'')+color
// 				document.getElementById('cb_message').style.color = (leadingHash?'#':'')+color
//			}
//			if(document.getElementById('cp_user_font_color')){
//				document.getElementById('cp_user_font_color').value = (leadingHash?'#':'')+color
//				document.getElementById('cp_user_font_color').style.color = (leadingHash?'#':'')+color
//				document.getElementById('cp_user_font_color').style.backgroundColor = (leadingHash?'#':'')+color
// 				document.getElementById('cp_message').style.color = (leadingHash?'#':'')+color
//			}
			if(reflectOnBackground) {
