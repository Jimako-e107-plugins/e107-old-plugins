 ...
 * @version   1.0.7
 * @link      http://cbcolor.com
 */


cb2color_register() // register cb2color_init() at page load


function cb2color_register() {
	if(typeof window.onload == 'function') {
		...
		window.onload = cb2color_init
	}
}

function cb2color_init() {

	// bind <input class="..."> elements
	var bindClass = 'cb2color'
	...
	function updateInput(e, color, realValue) {
		if(allowEmpty && realValue != null && !/^\s*#?([0-9A-F]{3}([0-9A-F]{3})?)\s*$/i.test(realValue)) {
			...
			e.style.color = (leadingHash?'#':'')+color
			e.style.backgroundColor = (leadingHash?'#':'')+color
			if(document.getElementById('cb2_user_font_color')){
				document.getElementById('cb2_user_font_color').value = color
//				document.getElementById('cb2_user_font_color').value = (leadingHash?'#':'')+color
				document.getElementById('cb2_user_font_color').style.color = (leadingHash?'#':'')+color
				document.getElementById('cb2_user_font_color').style.backgroundColor = (leadingHash?'#':'')+color
 				document.getElementById('cb2_message').style.color = (leadingHash?'#':'')+color
			}
			if(document.getElementById('cp2_user_font_color')){
				document.getElementById('cp2_user_font_color').value = color
//				document.getElementById('cp2_user_font_color').value = (leadingHash?'#':'')+color
				document.getElementById('cp2_user_font_color').style.color = (leadingHash?'#':'')+color
				document.getElementById('cp2_user_font_color').style.backgroundColor = (leadingHash?'#':'')+color
 				document.getElementById('cp2_message').style.color = (leadingHash?'#':'')+color
			}
//			if(reflectOnBackground) {
