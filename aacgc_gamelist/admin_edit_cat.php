...
if (isset($_POST['update_cat'])) {
        $message = ($sql->db_Update("aacgc_gamelist_cat", "cat_name='".$tp->toDB($_POST['cat_name'])."', cat_text='".$tp->toDB($_POST['cat_text'])."' WHERE cat_id='".$_POST['id']."' ")) ? "Successful updated" : "Update failed";
}

if (isset($_POST['main_delete'])) {
        $delete_id = array_keys($_POST['main_delete']);
	$sql2 = new db;
    $sql2->db_Delete("aacgc_gamelist_cat", "cat_id='".$delete_id[0]."'");
...
if ($action == "edit")
{
        ...
        <td style='width:70%' class='forumheader3'>
	    <textarea class='tbox' rows='25' cols='100' name='cat_text' onselect='storeCaret(this);' onclick='storeCaret(this);' onkeyup='storeCaret(this);'>".$row['cat_text']."</textarea><br>";
