...
if (!defined('WARS_ADMIN') or !preg_match("/admin\.php\?AddGame/i", $_SERVER['REQUEST_URI'])) {
	die ("Access Denied");
}
...
if($gname !=""){
	...
	if($result){
		$text .= "<center><br />"._GAMEADDED."<br /><br /></center>";
		header("Refresh:1;url=admin.php?games");
	}else{
		$text .= "<center><br />"._WERRORADDGAME."<br /><br /></center>";
