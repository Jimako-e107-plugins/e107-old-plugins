wars_jq().ready(function() {
	wars_jq("#opp_tag").autocomplete('clanwars.php?Search&type=opp_tag', {
		matchContains: true,
		selectFirst: false,
		minChars: 1
	}).result(function(){OppFields('tag');});
	wars_jq("#opp_name").autocomplete('clanwars.php?Search&type=opp_name', {
		matchContains: true,
		selectFirst: false,
		minChars: 1
	}).result(function(){OppFields('name');});
	wars_jq("#opp_url").autocomplete('clanwars.php?Search&type=opp_url', {
		matchContains: true,
		selectFirst: false,
		minChars: 1
	});
	wars_jq("#style").autocomplete('clanwars.php?Search&type=style', {
		matchContains: true,
		selectFirst: false,
		minChars: 1
	});
	wars_jq("#mapname").autocomplete('clanwars.php?Search&type=mapname&gid='+gid, {
		matchContains: true,
		selectFirst: false,
		mustMatch: mapmustmatch,
		minChars: 1
	});
	wars_jq("#gametype").autocomplete('clanwars.php?Search&type=gametype', {
		matchContains: true,
		selectFirst: false,
		minChars: 1
	});
	wars_jq("#playername0").autocomplete('clanwars.php?Search&type=player', {
		matchContains: true,
		selectFirst: false,
		minChars: 1
	}).result(function(){AddPlayer(0);});
	wars_jq("#playername1").autocomplete('clanwars.php?Search&type=player', {
		matchContains: true,
		selectFirst: false,
		minChars: 1
	}).result(function(){AddPlayer(1);});
	wars_jq("#playername2").autocomplete('clanwars.php?Search&type=player', {
		matchContains: true,
		selectFirst: false,
		minChars: 1
...
function OppFields(type){
    ...
    http.open("GET","clanwars.php?GetInfo&type=" + escape(type) + "&param=" + escape(param)+"&code="+Math.floor(Math.random()*99999),true);
...
function AddAutoComplete(id){
	wars_jq().ready(function() {
		wars_jq("#mapname"+id).autocomplete('clanwars.php?Search&type=mapname&gid='+gid, {
			matchContains: true,
			selectFirst: false,
			mustMatch: mapmustmatch,
			minChars: 1
...
function AddMap() {
    ...
    http.open("GET","clanwars.php?AddMap&mapname=" + escape(mapname) + "&gametype=" + escape(gametype) + "&our_score=" + parseInt(our_score) + "&opp_score=" + parseInt(opp_score) +"&wid=" + wid +"&gid=" + gid+"&code="+Math.floor(Math.random()*99999),true);
...
function DelMap(id) {
	...
	if(sure){
		http.open("GET","clanwars.php?DelMap&lid=" + id+"&code="+Math.floor(Math.random()*99999),true);
...
function SaveMap(id) {	
	...
	http.open("GET","clanwars.php?SaveMap&lid=" + id + "&mapname=" + escape(mapname) + "&gametype=" + escape(gametype) + "&our_score=" + parseInt(our_score) + "&opp_score=" + parseInt(opp_score)  + "&gid=" + gid + "&code="+Math.floor(Math.random()*99999),true);
...
function AddPlayer(avail) {
    ...
    //By calling this file, we have saved the data.
    http.open("GET","clanwars.php?AddPlayer&playername=" + escape(playername) + "&avail="  + parseInt(avail) + "&wid=" + parseInt(wid) + "&warstatus="+ parseInt(warstatus)+"&code="+Math.floor(Math.random()*99999),true);
            ...
            if(http.status == 200) {
                ...
                if(parseInt(result) > 0 || result.substring(0,7) == "updated") {
					if(result.substring(0,7) == "updated"){
						result = parseInt(result.substring(7));
					}
					if(avail > 0){
						document.getElementById("lineupdiv2").innerHTML = document.getElementById("lineupdiv2").innerHTML + '<span id="playerupc'+result+'" class="smallwrap forumheader3"><table cellpadding="2" cellspacing="0" border="0" width="100%"><tr> <td>&nbsp;'+playername+'</td> <td style="text-align:right;"><input type="button" class="iconpointer button" value="'+deltext+'" onclick="DelPlayer('+result+',2);"></td> </tr></table></span>';						
						document.getElementById("lineupdiv1").innerHTML = document.getElementById("lineupdiv1").innerHTML + '<span class="smallwrap forumheader3" id="playerfin'+result+'"> <table cellpadding="2" cellspacing="0" border="0" width="100%"><tr> <td>&nbsp;'+playername+'</td> <td style="text-align:right;"><input type="button" class="iconpointer button" value="'+deltext+'" onclick="DelPlayer('+result+',1);"></td> </tr></table> </span>';						
					}else{
						document.getElementById("lineupdiv0").innerHTML = document.getElementById("lineupdiv0").innerHTML + '<span class="smallwrap forumheader3" id="playerfin'+result+'"> <table cellpadding="2" cellspacing="0" border="0" width="100%"><tr> <td>&nbsp;'+playername+'</td> <td style="text-align:right;"><input type="button" class="iconpointer button" value="'+deltext+'" onclick="DelPlayer('+result+',0);"></td> </tr></table> </span>';
					}
...
function DelPlayer(id,avail) {
	...
	if(sure){
		http.open("GET","clanwars.php?DelPlayer&pid=" + id+"&code="+Math.floor(Math.random()*99999),true);
...
function DelScreen(id) {
	...
	if(sure){
		http.open("GET","clanwars.php?DelScreen&sid=" + id+"&code="+Math.floor(Math.random()*99999),true);
