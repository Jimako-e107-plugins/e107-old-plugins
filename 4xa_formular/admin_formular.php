...
for($i=0; $i < $fc; $i++)
		...
		$text .="<tr>
						<td style='width:30%; vertical-align:top' class='forumheader'><b>".$fields[$i]['form_opt_name']."".(($fields[$i]['field_pflicht'])?"<font style='color:#f00'> *</font>":"")."</b><br/><font style='font-size:80%;'>".($tp->toHTML($fields[$i]['form_opt_text'], TRUE))."</font></td>
