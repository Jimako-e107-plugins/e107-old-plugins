...
$tags_style_cloud = $plugPrefs['tags_style_cloud'];
$tags_style_item  = $plugPrefs['tags_style_item'];
$tags_style_link  = $plugPrefs['tags_style_link'];
$tags_min_size    = $plugPrefs['tags_min_size'];
$tags_max_size    = $plugPrefs['tags_max_size'];
