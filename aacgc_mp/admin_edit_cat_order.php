...
$tmp = explode(".", $id);
$sql->db_Update("aacgc_mp_cat", "cat_order=".$tmp[1]." WHERE cat_id=".$tmp[0]);
}
...
if ($action == "") {
        ...
        <tr>
        <td style='width:10%' class='forumheader3'>".AMP_39."</td>
        <td style='width:80%' class='forumheader3'>".AMP_35."</td>
        <td style='width:10%' class='forumheader3'> ".AMP_37." </td>
        </tr>";

	$cats = $sql->db_Select("aacgc_mp_cat", "*", "ORDER BY cat_order ASC", "");
	...
	<center>".$rs -> form_button("submit", "update_cat_order", "".AMP_42."")."</center>
	</td>
	</tr>
	</table>";
