...
If ($newok == "1"){
$sql->db_Insert("aacgc_mp_cat", "NULL, '".$newcattitle."','".$newcatdet."','".$newcatorder."'") or die(mysql_error());
$ns->tablerender("", "<center><b>".AMP_34."</b></center>");
}}
...
$text .= "
        <tr>
        <td style='width:20%; text-align:right' class='forumheader3'>".AMP_35.":</td>
...
$text .= "</div>
		...
		<input class='button' type='submit' value='".AMP_38."'>
		</td>
        </tr>
</table>
</div>
...
//---------------------------------------------------------------------------------------------------+
        ...
        $text .= "
	      ...
	      $ns -> tablerender("AACGC Meeting Planner (".AMP_40.")", $text);
