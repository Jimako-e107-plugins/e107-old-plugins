...
$text .= "
        ...
        <input class='tbox' type='text' name='meet_title' size='100'>
        </td>
        </tr>
        <tr>
        <td style='width:; text-align:right' class='forumheader3'>".AMP_03.":</td>
        <td style='width:' class='forumheader3' colspan=2>
		<textarea class='tbox' rows='25' cols='100' name='meet_det' onselect='storeCaret(this);' onclick='storeCaret(this);' onkeyup='storeCaret(this);'></textarea><br>";
        ...
        <input class='tbox' type='text' name='meet_subj' size='100'>
        </td>
        </tr>
        <tr>
...
$text .= "<tr>
		...
		<input class='button' type='submit' value='".AMP_10."'>
	      ...
	      $ns -> tablerender("AACGC Meeting Planner (".AMP_13.")", $text);
