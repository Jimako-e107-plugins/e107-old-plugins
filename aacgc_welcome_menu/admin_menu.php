...
$title .= "AACGC Welcome Menu Options";
...
{$text .= "<tr><td style='width:30%' class='button'><b><a style='cursor:hand; text-decoration:none' href='admin_main.php'>>> Main <<</a></b></td></tr>";}
else
{$text .= "<tr><td style='width:30%' class='button'><a style='cursor:hand; text-decoration:none' href='admin_main.php'>Main</a></td></tr>";}
...
{$text .= "<tr><td style='width:30%' class='button'><b><a style='cursor:hand; text-decoration:none' href='admin_config.php'>>> Menu Settings <<</a></b></td></tr>";}
else
{$text .= "<tr><td style='width:30%' class='button'><a style='cursor:hand; text-decoration:none' href='admin_config.php'>Menu Settings</a></td></tr>";}
