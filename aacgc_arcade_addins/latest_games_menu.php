...
$sql->mySQLresult = @mysql_query("SELECT game_id, game_filename, game_title, game_category, game_description, date_added, times_played, round((times_played / ((".(time())." - date_added)/86400)),2) as popularity FROM ".MPREFIX."arcade_games WHERE game_enable=1".$rest." ORDER BY date_added DESC LIMIT 0,".$pref['arcadeaddin_latestgamecount']."");
$rows = $sql->db_Rows();
...
$pop_title = "".$pref['arcadeaddin_latestgamecount']." Newest Arcade Games";
