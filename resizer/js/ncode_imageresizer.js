...
// e107  plugin by http://www.naja7host.com/
...
NcodeImageResizer.prototype.unScale = function() {
	switch(NcodeImageResizer.MODE) {
		...
		case 'tinybox':
			...
			break;			
		case 'tinybox2':
			TINY.box.show({image:''+this.img.src+'',});
			break;				
		case 'fancybox':
			return fancybox('<a href="'+this.img.src+'"><img id="fancybox" src="'+this.img.src+'" /></a>');
			break;				
		case 'enlarge':
		default:
			this.img.width = this.originalWidth;
