...
if (defined('CONFIG_PHP')) $lang_config_data = array(
  ...
  array('Thumbnail-Größe in Pixel', 'alb_list_thumb_size', 0),
  ...
  array('Aufeinanderfolgende Kommentare eines Benutzers zu einer Datei zulassen (Überflutungs-Schutz abschalten)', 'disable_comment_flood_protect', 1), //cpg1.3.0
  ...
  array('Maximalgröße Thumbnail<a href="#notice2" class="clickable_option">**</a>', 'thumb_width', 0), //cpg1.3.0
  array('Welche Dimension soll genutzt werden für Thumbnails ( Breite oder Höhe oder das, was jeweils größer ist)<a href="#notice1" class="clickable_option">**</a>', 'thumb_use', 7),
  ...
  array('Admin über genehmigungspflichtige Benutzer-Uploads per eMail benachrichtigen', 'upl_notify_admin_email', 1), //cpg1.3.0
...
if (defined('FAQ_PHP')) $lang_faq_data = array(
  ...
  array('Wie kann ich eine Datei hochladen?', 'Klicke auf &quot;Datei hochladen&quot; und wähle das Album aus, in das Du die Datei hochladen willst, klicke auf &quot;Durchsuchen&quot; und wähle die Datei aus, die Du hochladen willst und klicke dann auf &quot;öffnen&quot; (füge einen Titel, eine Beschriftung und ein paar Stichworte ein, wenn Du möchtest). Um den Vorgang abzuschliessen, klicke auf &quot;Datei hochladen&quot;', 'allow_private_albums', 0), //cpg1.3.0
  ...
  array('Welche Art und Größe von Dateien kann ich hochladen?', 'Die Art (z.B. jpg oder png) und Größe bestimmt der Administrator dieser Seite.', 'allow_private_albums', 0), //cpg1.3.0
  ...
  array('Was ist &quot;Dateien hochladen&quot;?', 'Dieses Feature ermöglicht es Benutzern, eigene Dateien hochzuladen und in Alben zu positionieren (Dateigröße und -typ wurden vom Admin festgelegt).', 'allow_private_albums', 0), //cpg1.3.0
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array(
  ...
  'note1' => '<b>(1)</b> Das Hochladen in ein öffentliches Album muss durch den Admin bestätigt werden',
  'note2' => '<b>(2)</b> Das Hochladen in ein privates Album muss durch den Admin bestätigt werden',
  'notes' => 'Anmerkungen'
);
...
if (defined('PHPINFO_PHP')) $lang_phpinfo_php = array(
  ...
  'explanation' => 'Diese Ausgabe wird durch die PHP-Funktion <a href="http://www.php.net/phpinfo">phpinfo()</a> erzeugt, und innerhalb von Coppermine angezeigt (dabei wird möglicherweise die Ausgabe einiger Felder am rechten Rand abgeschnitten).', //cpg1.3.0
...
if (defined('UPLOAD_PHP')) $lang_upload_php = array(
  ...
  'cust_instr_2' => 'Anzahl Abfrage-Felder', //cpg1.3.0   <--- Vergessen zu übersetzen??? Kenne den Zusammenhang leider nicht
  ...
  'reg_instr_2' => 'Du kannst jetzt Dateien mit den untenstehenden Feldern hochladen. Keine Datei darf größer als %s kB sein. ZIP-Dateien, die mit Datei-Upload oder URI/URL-Upload hochgeladen werden, bleiben komprimiert.', //cpg1.3.0
  ...
  'exc_php_ini' => 'Dateigröße größer als Limit in php.ini.', //cpg1.3.0
  'exc_file_size' => 'Dateigröße größer als Coppermine-Einstellungen.', //cpg1.3.0
  ...
  'pixel_allowance' => 'maximale Bild-Abmessungen (Pixel-Größe) überschritten.', //cpg1.3.0
  'incorrect_prefix' => 'Ungültige URI/URL Vorsible', //cpg1.3.0
  'could_not_open_URI' => 'Konnte URI nicht öffnen.', //cpg1.3.0
  'unsafe_URI' => 'Sicherheit nicht überprüfbar.', //cpg1.3.0
...
if (defined('UTIL_PHP')) $lang_util_php = array(
  ...
  'what_rebuild' => 'Erneuert Thumbnails und Dateien in Zwischengröße gemäß aktuellen Einstellungen',
  'what_delete_originals' => 'Löscht Bilder in Original-Größe und ersetzt sie mit Bildern in Zwischengröße',
  'file' => 'Datei',
