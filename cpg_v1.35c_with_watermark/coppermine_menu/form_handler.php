...
// --------------------------------- Radio buttons --------------------------------
   case "radio":
                            ...
                            $ret .="<label for='$fieldname$i'><input type='radio' name='$fieldname' id='$fieldname$i' value='$tmp[$i]' $checked  />$tmp[$i]</label>";
                            };
...
// --------------------------------- Textbox --------------------------------
   case "text":
                            ...
                            $size = ($tmp[1]) ? $tmp[1]:40;
                            $ret .="<input class='tbox' type='text' name='".$fieldname."' size='$size' value='".htmlentities($valuehere) ."' maxlength='$tmp[2]' />";
...
// --------------------------------- Images --------------------------------
   case "image":
        ...
        <input class='button' type ='button' style='cursor:pointer' size='30' value='".LAN_SELECT."' onclick='expandit(this)' />
...
function Color_Select($field,$dbvalue){
 ...
 /* $text .="<table cellspacing=\"0px\" cellpadding=\"4\" style='width:100%;border:0px'>
     <tr>
      ...
      <td style='width:100%'>&nbsp;<input class='button' type='button' value='".LAN_SELECT."' onClick='expandit(this)'>
  ...
  $text .= "&nbsp;#<input class='tbox' type=\"text\" name=\"".$field."\" id=\"".$field."\" value=\"".$dbvalue."\" size='15' onblur=\"View('".$field."',this.value)\" />
      &nbsp;<input class='button' type='button' value='".LAN_SELECT."' onclick='expandit(this)' />";
