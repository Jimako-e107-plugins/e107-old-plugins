...
define("LAN_T36","");
define("LAN_T37","User said Thank to");
define("LAN_T38","for this Post");
define("LAN_T39","(Today)");
define("LAN_T40","(Yesterday)");
define("LAN_T41","(2 Days ago)");
define("LAN_T42","(3 Days ago)");
define("LAN_T43","(4 Days ago)");
define("LAN_T44","(5 Days ago)");
define("LAN_T45","(6 Days ago)");
define("LAN_T46","(Last Week)");

// Ajax Errors
define("LAN_T47","Requesting Content's , Please Wait ...");
define("LAN_T48","Error !");
define("LAN_T49","Oooops Time is up , Try again !");
define("LAN_T50","Delete my Thank");

//File Manager

define("LAN_TFM1","Thanks Buttons");
define("LAN_TFM2","Loading's Icon");
define("LAN_TFM3","Home (For uploading)");
define("LAN_TFM4","Directory");
