			...
			<tr>
				<td class='forumheader3' style='width:20%'>".EC_LAN_55."</td><td class='forumheader3' >
					...
					foreach($imagelist as $img)
					{
						if ($img['fname'])
						{
							//$calendarmenu_text .= "<a href='javascript:insertext(\"{$img['fname']}\", \"caticon\", \"cat_icons\")'><img src='".e_PLUGIN_ABS."calendar_menu/images/".$img['fname']."' style='border:0px' alt='' /></a>\n ";
							$calendarmenu_text .= "<img src='".e_PLUGIN_ABS."calendar_menu/images/".$img['fname']."' onclick='insertext(\"{$img['fname']}\", \"caticon\", \"cat_icons\")' style='border:0px' alt='' />\n ";
						}
					}
					$calendarmenu_text .= "
					</div>
