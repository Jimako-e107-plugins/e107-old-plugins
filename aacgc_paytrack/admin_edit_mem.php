...
$text .= "<a href='".e_SELF."?edit.{$row['pay_id']}'>".ADMIN_EDIT_ICON."</a>";
$text .= "<input type='image' title='".LAN_DELETE."' name='main_delete[".$row['pay_id']."]' src='".ADMIN_DELETE_ICON_PATH."' onclick=\"return jsconfirm('".LAN_CONFIRMDEL." [ID: {$row['pay_id']} ]')\"/>
                </td>
        </tr>";
		}
$text .= "</table>
...
$text .= $rs->form_close();
	...
	$ns -> tablerender("AACGC Payment Tracker (".APT_17.")", $text);
...
$text .= "<div style='text-align:center'>
	...
	<td colspan='2'  class='forumheader3'>
            ".$pref['aacgcpt_csymbol']."".$rs -> form_text("user_camount", 100, $row['user_camount'], 500)."
	</td>
	</tr>
	<tr>
	<td style='width:; text-align:right' class='forumheader3'>".APT_83.":</td>
	<td colspan='2'  class='forumheader3'>
            ".$pref['aacgcpt_csymbol']."".$rs -> form_text("user_damount", 100, $row['user_damount'], 500)."
	</td>
	</tr>
	<tr>
	<td style='width:; text-align:right' class='forumheader3'>".APT_89.":</td>
	<td colspan='2'  class='forumheader3'>
            ".$pref['aacgcpt_csymbol']."".$rs -> form_text("user_tamount", 100, $row['user_tamount'], 500)."
	</td>
	</tr>
