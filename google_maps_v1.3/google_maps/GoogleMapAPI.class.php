...
//get config info
$sql5 =new db;
$sql5 -> db_Select("google_maps", "*", "map_id='1'");
...
define("map_control",$map_control);

if ($map_control_type == 0){
define("map_control_type", small);
}else{
define("map_control_type", large);
}

define("map_type_control",$map_type_control);




if ($map_type_default == 1){
define("map_type_default", G_NORMAL_MAP);
}

if ($map_type_default == 2){
define("map_type_default", G_SATELLITE_MAP);
}

if ($map_type_default == 3){
define("map_type_default", G_HYBRID_MAP);
}

define("map_scale_control",$map_scale_control);
define("map_overview_control",$map_overview_control);
define("map_zoom",$map_zoom);
define("map_height",$map_height);
define("map_width",$map_width);
define("map_sidebar",$map_sidebar);
define("map_infowindow",$map_infowindow);
...
class GoogleMapAPI {
     ...
     * @var boolean
     */
    var $type_controls = map_type_control;
     ...
     * @var boolean
     */
    var $overview_control = map_overview_control;
     ...
     * @var boolean
     */
    var $info_window = map_infowindow;
     ...
     * @var string
     */
    var $_db_cache_table = 'e107_google_maps_geo';
    ...
    function setLookupService($service) {
       ...
       function getdata($add, $name, $name2){
    ...
    */
    ...
    function getCache($address) {
      //  if(!isset($this->dsn))
		...
		$sql3 =new db;
		$sql3-> db_Select("google_maps_geo", "*", "address ='".$address."'");
		//$sql3 -> db_Select("google_maps", "*", "map_id='1'");
...
$sql4 =new db;
$sql4-> db_Insert("google_maps_geo", "'".$address."', '".$lon."', '".$lat."'");
