...
|	e107 website system
| http://e107.org
|	/image_gallery/admin_modify-album.php
|
| Revision: 0.9.6.5
| Date: 2008/02/15
| Author: Krassswr
...
if (!isset($_GET['alId'])) {
	...
	echo "<script>window.location.href='admin_config.php?page=admin_album-detail&alId=$albumId';</script>";
} else {
	// get the album id
	$alId = (int)$_GET['alId'];

    $mydb->db_Select("tbl_album", "al_id, al_name, al_description, al_image, al_cat_id", "WHERE al_id = $alId", "");
...
$text .="	<p align='center'>Album not found. Click <a href='admin_config.php'>here</a> to go to the album list</p>";
