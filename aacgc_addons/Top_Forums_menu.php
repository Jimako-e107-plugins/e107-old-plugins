...
$f_title = "".$pref['menu_topftitle'].""; 
		...
		$f_text .= "
			...
			<td style='width:10%' class=''><u>Posts</u></td>
			</tr>";

$n = "0";
$sql ->db_Select("user", "*", "ORDER BY user_forums DESC LIMIT 0,".$pref['menu_topfcount']."","");
...
{$userorb = "".$row['user_name']."";}
		...
		$f_text .= "<tr>
			  ...
			  <td style='width:10%' class=''><center>".$row['user_forums']."</center></td>
			  </tr>";}
