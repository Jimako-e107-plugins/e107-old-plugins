...
include_lan(e_PLUGIN."ppgallery/languages/".e_LANGUAGE."/delete.php");
...
if (isset($_POST['delete']))
{
	...
	$sql->db_Select_gen("DELETE FROM ".MPREFIX."ppgallery_images WHERE image=".$id."");
	$caption=PPGLAN_06;
	$text="
		<p class='center'>
			".PPGLAN_01."
...
elseif (isset($_POST['nope'])) {header("location:".e_PLUGIN."ppgallery/gallery.php?id=".$image['is_gallery']."");exit;}
else
{
	$caption=PPGLAN_05;
	$text="
		<form action='".e_SELF."?id=".$id."' method='post'>
			<div class='center'>
				...
				".PPGLAN_03."
				<br /><br />
				<input type='submit' name='delete' class='button' value='".PPGLAN_04."' />
				<input type='submit' name='nope' class='button' value='".PPGLAN_07."' />
			</div>
		</form>
	";
}
