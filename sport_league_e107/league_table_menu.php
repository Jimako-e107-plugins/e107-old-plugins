...
|
|		$Source: ../e107_plugins/sport_league_e107/league_table_menu.php
|		$Revision: 0.84 $
|		$Date: 2010/02/04 $
|		$Author: ***RuSsE*** $
+---------------------------------------------------------------+
...
if($pref['sport_league_logo_w_menu']!="")
 {
 $LOGO_SIZE=" width='".$pref['sport_league_logo_w_menu']."' ";
 $TAX=$LOGO_SIZE;
 }
elseif($pref['sport_league_logo_h_menu']!="")
 {
$LOGO_SIZE=" height='".$pref['sport_league_logo_h_menu']."' ";
$TAX=10;
 }
else
{$LOGO_SIZE="";}
...
$gesammt .="<td class='".$zeilestyle."' style='border-top:0px;font-weight:bold;width:45%;text-align:left;'><div style='cursor:pointer' onclick=\"expandit('exp_menu_ges".$TEAM[$JS][0][$i]."_".$JS."')\">".$TEAM[$JS][3][$i]."</div>
<div id='exp_menu_ges".$TEAM[$JS][0][$i]."_".$JS."' style='".$expand_autohide."' colspan='10' >";
$gesammt .=team_links($TEAM[$JS][26][$i], $TEAM[$JS][3][$i], $SAISON[$JS]['league_id'], $TEAM[$JS][2][$i]);
$gesammt .="</div></td>";
$gesammt .="<td class='".$zeilestyle."' style='border-left:0px;border-top:0px;padding-top:2px;padding-bottom:2px;width:10%;text-align:center;'>".$TEAM[$JS][14][$i]."</td>";
if($TEAM[$JS][6][$i]==''){$TEAM[$JS][6][$i]='0';}
$gesammt .="<td class='".$zeilestyle."' style='border-left:0px;border-top:0px;padding-top:2px;padding-bottom:2px;width:10%;text-align:center;'>".$TEAM[$JS][6][$i]."</td>";
$gesammt .="	</tr>";
    }
$gesammt .="</table></div>";
$inhalttext .=$gesammt;
...
$ausg_home ="<div id='exp_menu_home_table_".$JS."' style='$expand_autohide'>
			  <b>".LAN_LEAGUE_TABLE_MENU_15."</b> ".$Ligatext." <br/>
				<table cellpadding='0' cellspacing='0' width='100%'>
					<tr>	
						<td class='forumheader2' style='text-align:center; width:33%; height: 10px'><b>".LAN_LEAGUE_TABLE_MENU_09."</b>			
						</td>
						<td class='forumheader' style='text-align:center; width:33%; height: 10px'>
...
for($i=0; $i < $count[$JS]; $i++)     
   {
   	...
   	if($TEAM[$JS][27][$i]=='1' && $pref['sport_league_tab_myteam']=='0')
		...
		$ausg_home .="<td class='".$zeilestyle."' style='border-top:0px;font-weight:bold;width:45%;text-align:left;'><div style='cursor:pointer' onclick=\"expandit('exp_menu_home".$TEAM[$JS][0][$i]."_".$JS."')\">".$TEAM[$JS][3][$i]."</div>
									<div id='exp_menu_home".$TEAM[$JS][0][$i]."_".$JS."' style='".$expand_autohide."' colspan='10' >";
		$ausg_home .=team_links($TEAM[$JS][26][$i], $TEAM[$JS][3][$i], $SAISON[$JS]['league_id'], $TEAM[$JS][2][$i]);
		$ausg_home .="</div></td>";
		$ausg_home .="<td class='".$zeilestyle."' style='border-left:0px;border-top:0px;padding-top:2px;padding-bottom:2px;width:10%;text-align:center;'>".$TEAM[$JS][12][$i]."</td>";
		if($TEAM[$JS][29][$i]==''){$TEAM[$JS][29][$i]='0';}
		$ausg_home .="<td class='".$zeilestyle."' style='border-left:0px;border-top:0px;padding-top:2px;padding-bottom:2px;width:10%;text-align:center;'>".$TEAM[$JS][29][$i]."</td>";
		$ausg_home .="	</tr>";
    }
$ausg_home .="</table></div>";
...
<div id='exp_menu_gast_table_".$JS."' style='$expand_autohide'>
				...
				<table cellpadding='0' cellspacing='0' width='100%'>
					<tr>	
						...
						<td class='forumheader2' style='text-align:center; width:33%; height: 10px'><b>".LAN_LEAGUE_TABLE_MENU_10."</b>
						</td>
					</tr>
				</table>
						<table style='width:100%' cellspacing='0' cellpadding='0'><tr>";
...
$ausg_gast .="<td class='".$zeilestyle."' style='border-top:0px;font-weight:bold;width:45%;text-align:left;'><div style='cursor:pointer' onclick=\"expandit('exp_menu_gast".$TEAM[$JS][0][$i]."_".$JS."')\">".$TEAM[$JS][3][$i]."</div>
<div id='exp_menu_gast".$TEAM[$JS][0][$i]."_".$JS."' style='".$expand_autohide."' colspan='10' >";
$ausg_gast .=team_links($TEAM[$JS][26][$i], $TEAM[$JS][3][$i], $SAISON[$JS]['league_id'], $TEAM[$JS][2][$i]);
$ausg_gast .="</div></td>";
$ausg_gast .="<td class='".$zeilestyle."' style='border-left:0px;border-top:0px;padding-top:2px;padding-bottom:2px;width:10%;text-align:center;'>".$TEAM[$JS][13][$i]."</td>";
if($TEAM[$JS][28][$i]==''){$TEAM[$JS][28][$i]='0';}
$ausg_gast .="<td class='".$zeilestyle."' style='border-left:0px;border-top:0px;padding-top:2px;padding-bottom:2px;width:10%;text-align:center;'>".$TEAM[$JS][28][$i]."</td>";
$ausg_gast .="	</tr>";
    }
$ausg_gast .="</table></div>";
...
////////#############################################
$inhalttext .="<a href='".e_PLUGIN."sport_league_e107/league_table.php?".$SAISON[$JS]['saison_id'].".".$SAISON[$JS]['league_id'].".'>".LAN_LEAGUE_TABLE_MENU_06."</a><br/>-----<br/></div>";
$text .=$inhalttext;	
	}
}
$title = LAN_LEAGUE_TABLE_MENU_07;
...
$text .=powered_by();
/// =========================================================================================
$ns ->tablerender($title, $text, 'league_table_menu');
?>