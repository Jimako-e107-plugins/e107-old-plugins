...
<table style='width:100%;background:transparent;font-size:100%;' cellspacing='0' cellpadding='0'>
						<tr>
							<td style='vertical-align:middle;text-align:right;background:transparent;width:45%;'>
								<a target='_blank' href='".$GAME['home_team_url']."' title='".LAN_LAST_NEXT_GAME_1." ".$GAME['home_team_name']."'>
									<img border='0' src='".e_PLUGIN."sport_league_e107/logos/big/".$GAME['home_team_icon']."' width='200'>
								</a>
							</td>
							...
							<td style='vertical-align: middle; text-align:left; background:transparent; width:45%;'>
								<a target='_blank' href='".$GAME['gast_team_url']."' title='".LAN_LAST_NEXT_GAME_1." ".$GAME['gast_team_name']."'>
									<img border='0' src='".e_PLUGIN."sport_league_e107/logos/big/".$GAME['gast_team_icon']."' width='200'>
								</a>
							</td>
						</tr>
						<tr>
...
$lastgame_text .="<b/>";
$lastgame_text .="	<table style='width:100%;background:transparent;font-size:100%;' cellspacing='0' cellpadding='0'>
						<tr>
					...
					if($pref['sport_league_periods']>2){
						...
						<tr>
							<td class='forumheader3' style='width:10%;vertical-align: middle; text-align:center;border-top:0px;'>
								<a target='_blank' href='".$GAME['home_team_url']."' title='".LAN_LAST_NEXT_GAME_1." ".$GAME['home_team_name']."'>
									<img border='0' src='".e_PLUGIN."sport_league_e107/logos/".$GAME['home_team_icon']."' height='100px'>
								</a>
							</td>
		...
		$lastgame_text .="</div>
				...
				if($pref['sport_league_periods']>2){
						...
						<tr>
							<td class='forumheader3' style='width:10%;vertical-align: middle; text-align:center;border-top:0px;'>
								<a target='_blank' href='".$GAME['gast_team_url']."' title='".LAN_LAST_NEXT_GAME_1." ".$GAME['gast_team_name']."'>
									<img border='0' src='".e_PLUGIN."sport_league_e107/logos/".$GAME['gast_team_icon']."' height='100px'>
								</a>
							</td>
							<td class='forumheader3' style='width:62%;vertical-align: middle; text-align:left;border-top:0px;border-left:0px;font-weight: bold;'>
						...
						<tr>
							<td style='vertical-align:middle;text-align:right;background:transparent;width:45%;'>
								<a target='_blank' href='".$GAME2['home_team_url']."' title='".LAN_LAST_NEXT_GAME_1." ".$GAME2['home_team_name']."'>
									<img border='0' src='".e_PLUGIN."sport_league_e107/logos/big/".$GAME2['home_team_icon']."' width='200'>
								</a>
							</td>
...
$nextgame_text .="	<table style='width:100%;background:transparent;font-size:100%;' cellspacing='0' cellpadding='0'>
						<tr>
						...
						<tr>
							<td class='forumheader3' style='width:10%;vertical-align: middle; text-align:center;border-top:0px;'>
								<a target='_blank' href='".$GAME2['home_team_url']."' title='".LAN_LAST_NEXT_GAME_1." ".$GAME2['home_team_name']."'>
									<img border='0' src='".e_PLUGIN."sport_league_e107/logos/".$GAME2['home_team_icon']."' height='100px'>
								</a>
							</td>
							<td class='forumheader3' style='width:62%;vertical-align: middle; text-align:left;border-top:0px;border-left:0px;font-weight: bold;'>
		...
		$nextgame_text .="</td>
						...
						<tr>
							<td class='forumheader3' style='width:10%;vertical-align: middle; text-align:center;border-top:0px;'>
								<a target='_blank' href='".$GAME2['gast_team_url']."' title='".LAN_LAST_NEXT_GAME_1." ".$GAME2['gast_team_name']."'>
									<img border='0' src='".e_PLUGIN."sport_league_e107/logos/".$GAME2['gast_team_icon']."' height='100px'>
								</a>
							</td>
							<td class='forumheader3' style='width:62%;vertical-align: middle; text-align:left;border-top:0px;border-left:0px;font-weight: bold;'>
...
if($GAME2['game_league_id']!=''){$Saison_ID_for_Link=$GAME2['game_league_id'];}
	...
	$text .="<div style='width:100%; text-align:center;font-size:70%;'><a href='".e_PLUGIN."sport_league_e107/league_games.php?Liga=".$Saison_ID_for_Link."'>".LAN_LAST_NEXT_GAME_3."</a><br/></div>";
	if($saisoncount > 1)
		{
...
{
$text=LAN_LAST_NEXT_GAME_12; ///Keine Date liegen vor oder der Saison nicht ausgewÃƒÆ’Ã‚Â¤hlt!!!
}			                                                                                                                                                                                                                                                                                   
