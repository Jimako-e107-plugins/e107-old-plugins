...
|
|		$Source: ../e107_plugins/sport_league_e107/admin/admin_pref_poinssystem.php $
|		$Revision: 0.87 $
|		$Date: 29.09.2011 17:06 $
|		$Author: ***RuSsE*** $
+---------------------------------------------------------------+
*/
...
$lan_file = e_PLUGIN."sport_league_e107/languages/".e_LANGUAGE."/admin_pref_poinssystem_lan.php";
require_once(file_exists($lan_file) ? $lan_file :  e_PLUGIN."sport_league_e107/languages/German/admin_pref_poinssystem_lan.php");

require_once("../functionen.php");

$ImageHELP['PFAD']=e_PLUGIN."sport_league_e107/images/system/help.png";
$ImageHELP['LINK']="<img border='0' style='vertical-align: middle' title='".LAN_LEAGUE_PREFS_22."' src='".$ImageHELP['PFAD']."'>";

  $preftitle = LAN_LEAGUE_PREFS_0;//
	$pageid = "prefs3";
//0
    $prefcapt[0] = LAN_LEAGUE_PREFS_1;//Spiel Verlängerung
    $prefname[0] = "sport_league_game_un";
    $preftype[0] = "checkbox";
    $prefvalu[0] = "0";
    $prefhelp[0]	=	LAN_LEAGUE_PREFS_2;
//1
		$prefcapt[1] = LAN_LEAGUE_PREFS_3;//Puntke Unentschieden
    $prefname[1] = "sport_league_game_unistun";
    $preftype[1] = "text";
		$prefvalu[1] = "~3";
		$prefhelp[1]	=	LAN_LEAGUE_PREFS_4;
//2
		$prefcapt[2] = LAN_LEAGUE_PREFS_5;//Sieger- Punkte
    $prefname[2] = "sport_league_points_winer";
    $preftype[2] = "text";
		$prefvalu[2] = "~3";
		$prefhelp[2]	=	LAN_LEAGUE_PREFS_6;
//3
		$prefcapt[3] = LAN_LEAGUE_PREFS_7;//Verlierer- Punkte
    $prefname[3] = "sport_league_points_louser";
    $preftype[3] = "text";
		$prefvalu[3] = "~3";
		$prefhelp[3]	=	LAN_LEAGUE_PREFS_8;
//4		
		$prefcapt[4] = LAN_LEAGUE_PREFS_9;//Sieger n.P- Punkte
    $prefname[4] = "sport_league_points_winer2";
    $preftype[4] = "text";
		$prefvalu[4] = "~3";
		$prefhelp[4]	=	LAN_LEAGUE_PREFS_10;
//5		
		$prefcapt[5] = LAN_LEAGUE_PREFS_11;//Verlierer n.P- Punkte
    $prefname[5] = "sport_league_points_louser2";
    $preftype[5] = "text";
		$prefvalu[5] = "~3";
		$prefhelp[5]	=	LAN_LEAGUE_PREFS_12;
//6		
		$prefcapt[6] = LAN_LEAGUE_PREFS_16;//Anzahl der Perioned / Halbzeiten
    $prefname[6] = "sport_league_periods";
    $preftype[6] = "text";
		$prefvalu[6] = "~3";
		$prefhelp[6]	=	LAN_LEAGUE_PREFS_17;
//7	
		$prefcapt[7] = LAN_LEAGUE_PREFS_18;//Spieldauer pro Period / Halbzeit
    $prefname[7] = "sport_league_times";
    $preftype[7] = "text";
		$prefvalu[7] = "~5";
		$prefhelp[7]	=	LAN_LEAGUE_PREFS_19;
//---------------------------------------------------------------
...
<div style='text-align:center'>
	...
	<form method='post' action='".e_SELF."'>
		<tr>
			<td class='forumheader' style='width:100%;text-align:center;' colspan='2'><b>".LAN_LEAGUE_PREFS_13."</b></td>
		</tr>
		<tr>
		...
		<tr>
			<td class='forumheader' style='width:100%;text-align:center;' colspan='2'><b>".LAN_LEAGUE_PREFS_14."</b></td>
		</tr>
		<tr>
		...
		<tr>
			<td class='forumheader' style='width:100%;text-align:center;' colspan='2'><b>".LAN_LEAGUE_PREFS_15."</b></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class='forumheader3' style='width:50%;vertical-align:top;'><div style='cursor:pointer' onclick=\"expandit('help7')\">".$ImageHELP['LINK']."</div>
				...
				$name = $prefname[7];
				$text .= $rs->  user_extended_element_edit($form_send,$pref[$name],$name);	
				$text .=" ".LAN_LEAGUE_PREFS_20." </td>
		</tr>
";

$text .="<tr style='vertical-align:top'>
    <td colspan='2'  style='text-align:center' class='forumheader'>
    <input class='button' type='submit' name='updatesettings' value='".LAN_LEAGUE_PREFS_21."' />
    </td>
    </tr>
    </table>
    </form>
