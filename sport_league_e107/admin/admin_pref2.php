...
//5
    ...
    $preftype[] = "radio";
		$prefvalu[] = "1:".LAN_LEAGUE_PREFS_16."~2:".LAN_LEAGUE_PREFS_17."~3:".LAN_LEAGUE_PREFS_121."~4:".LAN_LEAGUE_PREFS_122."~5:".LAN_LEAGUE_PREFS_123."";
...
//14
		$prefcapt[] = LAN_LEAGUE_PREFS_124;
    $prefname[] = "sport_league_Menu_wat_logo";
		$preftype[] = "radio";
		$prefvalu[] = "1:".LAN_LEAGUE_PREFS_125."~2:".LAN_LEAGUE_PREFS_126."";
		$prefhelp[]	=	LAN_LEAGUE_PREFS_127;
//15
	...
	<form method='post' action='".e_SELF."'>
		...
		<tr>
			<td class='forumheader3' style='width:50%;vertical-align:top;'><div style='cursor:pointer' onclick=\"expandit('help3')\">".$ImageHELP['LINK']."</div>
						...
						<b>".LAN_LEAGUE_PREFS_128."</b>-".LAN_LEAGUE_PREFS_129."<br/><br/>
						</div>
