...
|
|		$Source: ../e107_plugins/sport_league_e107/admin/admin_pref_ligatable.php  $
|		$Revision: 0.87 $
|		$Date: 29.09.2011 17:18 $
|		$Author: ***RuSsE*** $
+---------------------------------------------------------------+
*/
...
$lan_file = e_PLUGIN."sport_league_e107/languages/".e_LANGUAGE."/admin_pref_ligatable_lan.php";
require_once(file_exists($lan_file) ? $lan_file :  e_PLUGIN."sport_league_e107/languages/German/admin_pref_ligatable_lan.php");
...
// ++++++++ ADMIN PREFERENCE CONFIGURATION +++++++++++++++++++++++++++++++++++++
  $preftitle = LAN_LEAGUE_PREFS_00;//Liga-Tabelle
	$pageid = "prefs4";

//0
		$prefcapt[0] = LAN_LEAGUE_PREFS_01;//Teamname in der Tabelle
    $prefname[0] = "sport_league_teamname_table";
    $preftype[0] = "dropdown2";
		$prefvalu[0] = "1:".LAN_LEAGUE_PREFS_24."~2:".LAN_LEAGUE_PREFS_25."";
		$prefhelp[0]	=	LAN_LEAGUE_PREFS_02;
//1
    $prefcapt[1] = LAN_LEAGUE_PREFS_03;//Logo in der Tabelle
    $prefname[1] = "sport_league_tab_logo";
    $preftype[1] = "checkbox";
    $prefvalu[1] = "0";
    $prefhelp[1]	=	LAN_LEAGUE_PREFS_04;
//2
		$prefcapt[2] = LAN_LEAGUE_PREFS_05;//Breite
    $prefname[2] = "sport_league_tab_W";
    $preftype[2] = "text";
		$prefvalu[2] = "~3";
		$prefhelp[2]	=	LAN_LEAGUE_PREFS_06;
//3
		$prefcapt[3] = LAN_LEAGUE_PREFS_07;//Höhe
    $prefname[3] = "sport_league_tab_H";
    $preftype[3] = "text";
		$prefvalu[3] = "~3";
		$prefhelp[3]	=	LAN_LEAGUE_PREFS_08;	
//4
		$prefcapt[4] = LAN_LEAGUE_PREFS_09;//KLASS- 1
...
//5
		$prefcapt[5] = LAN_LEAGUE_PREFS_11;//KLASS- 2
...
//6
		$prefcapt[6] = LAN_LEAGUE_PREFS_13;//KLASS- 3
    ...
    $preftype[6] = "dropdown2";
		...
		$prefhelp[6]	=	LAN_LEAGUE_PREFS_14;
//7
		$prefcapt[7] = LAN_LEAGUE_PREFS_15;//Mein Team extra
    $prefname[7] = "sport_league_tab_myteam";
    $preftype[7] = "checkbox";
		$prefvalu[7] = "0";
		$prefhelp[7]	=	LAN_LEAGUE_PREFS_16;
//10
		$prefcapt[10] = LAN_LEAGUE_PREFS_31;//Tabelle spalten
    $prefname[10] = "sport_league_tab_spalten";
    $preftype[10] = "checkbox";
		$prefvalu[10] = "0";
		$prefhelp[10]	=	LAN_LEAGUE_PREFS_35;
//11
		$prefcapt[11] = LAN_LEAGUE_PREFS_26;//Obere Grenze ab
    $prefname[11] = "sport_league_tab_spalt_ab";
    $preftype[11] = "text";
		$prefvalu[11] = "~3";
		$prefhelp[11]	=	LAN_LEAGUE_PREFS_27;
//12
		$prefcapt[12] = LAN_LEAGUE_PREFS_28;//Untere Grenze ab
    $prefname[12] = "sport_league_tab_spalt_bis";
    $preftype[12] = "text";
		$prefvalu[12] = "~3";
		$prefhelp[12]	=	LAN_LEAGUE_PREFS_29;
//13
		$prefcapt[13] = LAN_LEAGUE_PREFS_32;//Zebra- Effekt
    $prefname[13] = "sport_league_tab_zebra";
    $preftype[13] = "checkbox";
		$prefvalu[13] = "0";
		$prefhelp[13]	=	LAN_LEAGUE_PREFS_33;
//------------------------------------------------------------------------
...
<div style='text-align:center'>
	...
	<form method='post' action='".e_SELF."'>
		<tr>
			<td class='forumheader' style='width:100%;text-align:center;' colspan='2'><b>".LAN_LEAGUE_PREFS_30."</b></td>
		</tr>
		<tr>
