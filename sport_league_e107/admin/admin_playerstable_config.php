...
$ImageSORT1['LINK']="<img border='0' style='vertical-align: middle' title='Nach oben' src='".$ImageSORT1['PFAD']."'>";
...
// ++++++++ ADMIN TABLE PAGE CONFIGURATION +++++++++++++++++++++++++++++++++++++
    ...
    $e_wysiwyg = "";
    $pageid = "admin_playerstable";

    $fieldcapt[] = "players_extended_struct_name";//Feld Name: Name des Feldes, der in der Datenbank gesetzt wird. Muss sich von bestehenden Feldnamen unterscheiden und darf nicht in der Haupt-User-Tabelle verwendet werden 
    $fieldname[] = "players_extended_struct_name";
    $fieldtype[] = "text";  
    $fieldvalu[] = "";

    $fieldcapt[] = "players_extended_struct_text";//Feld Text: Angezeigter Name des Feldes auf der generierten Seite 
    $fieldname[] = "players_extended_struct_text";
    $fieldtype[] = "text";  
    $fieldvalu[] = "";

    $fieldcapt[] = "players_extended_struct_type";//Feld Typ 
    $fieldname[] = "players_extended_struct_type";
    $fieldtype[] = "dropdown2";  
    $fieldvalu[] = "1:Text Box~2:Radio Buttons~3:Drop-Down Menü~4:DB Tabelle Menü~5:Text- Bereich~6:Datum";

    $fieldcapt[] = "players_extended_struct_parms";//
    $fieldname[] = "players_extended_struct_parms";
    $fieldtype[] = "text";  
    $fieldvalu[] = "";

    $fieldcapt[] = "players_extended_struct_values";//Werte: Trage die Werte getrennt durch Komma ein, z.B. value1,value2 usw Für DB Tabellen bitte das Format benutzen: dbtable,field-value,field-name.
    $fieldname[] = "players_extended_struct_values";
    $fieldtype[] = "text";  
    $fieldvalu[] = "";

    $fieldcapt[] = "players_extended_struct_default";// Gesetzer Wert
    $fieldname[] = "players_extended_struct_default";
    $fieldtype[] = "text";  
    $fieldvalu[] = "";  

    $fieldcapt[] = "players_extended_struct_read";// Leseberechtigung Legt fest wer den Wert auf der Benutzerseite angezeigt bekommt. 
    $fieldname[] = "players_extended_struct_read";
    $fieldtype[] = "accesstable";  
    $fieldvalu[] = "";  

    $fieldcapt[] = "players_extended_struct_write";// Schreibberechtigung Legt fest wer dieses feld in seinen Einstellungen sieht. 
    $fieldname[] = "players_extended_struct_write";
    $fieldtype[] = "accesstable";  
    $fieldvalu[] = "";  

    $fieldcapt[] = "players_extended_struct_required";// Erforderlich
    $fieldname[] = "players_extended_struct_required";
    $fieldtype[] = "dropdown2";
    $fieldvalu[] = "1:nein~2:ja";

    $fieldcapt[] = "players_extended_struct_signup";// ???
    $fieldname[] = "players_extended_struct_signup";
    $fieldtype[] = "text";
    $fieldvalu[] = ""; 
    
    $fieldcapt[] = "players_extended_struct_applicable";// Anwendbar Legt fest welchen Benutzern dieses Feld angezeigt wird. 
    $fieldname[] = "players_extended_struct_applicable";
    $fieldtype[] = "accesstable";
    $fieldvalu[] = "";     
    
    $fieldcapt[] = "players_extended_struct_order";// 
    $fieldname[] = "players_extended_struct_order";
    $fieldtype[] = "text";
    $fieldvalu[] = "";     
 
    $fieldcapt[] = "players_extended_struct_parent";//
...
if ($action == "edit")
	...
	$configtitle="<b>".LAN_LEAGUE_STADIONS_ADMIN_19."".$row['team_name']."</b>";	
	}
...
///////////////////////////Tabelle mit vorhandenen Stadions zeigen. Ersmal Überschrift...///////////////
 ...
 <a href='".e_SELF."?neu.0'>".$ImageNEW['LINK']."  Neues Spieler- Parameter erstellen </div></a>
 </form>
 <br/>
 <br/><table style='width:96%' class='fborder' cellspacing='0' cellpadding='0'>";
	 $text .="<tr>
	  <td class='fcaption' style='align:center;width:'>Name</td>
	 	<td class='fcaption' style='align:left'>Typ</td>
		<td class='fcaption' style='align: center;width:'>Überschrift</td>
		<td class='fcaption' style='align:center;width:'>Sicht. für</td>
		<td class='fcaption' style='align:center;width:'>Pflicht</td>
		<td class='fcaption' style='align:center;width:'>Optionen</td>
		<td class='fcaption' style='align:center;width:'>Sort</td>
	</tr>";

$RECHE[0]="Jeder";
$RECHE[252]="Nur Gäste";
$RECHE[253]="Nur Mitglieder";
$RECHE[254]="Nur Admins";
$RECHE[255]="keiner (inaktiv)";
...
$FIELDTYP[0]="nicht dev.";
$FIELDTYP[1]="Text Box";
$FIELDTYP[2]="Radio Buttons";
$FIELDTYP[3]="Drop-Down Menü";
$FIELDTYP[4]="DB-Tabelle Menü";
$FIELDTYP[5]="Text-Bereich";
$FIELDTYP[6]="Datum";
	 ...
	 while($row = $sql-> db_Fetch()){
	 	 $count1++;
			...
			$text .="<td class='forumheader3'><form method='post' action='".e_SELF."' id='editform'>
																				...
																				<input type='image' title='".LAN_DELETE."' name='delete[team_{$row['players_extended_struct_id']}]' style='vertical-align: middle' src='".$ImageDELETE['PFAD']."' onclick=\"return jsconfirm('".LAN_LEAGUE_STADIONS_ADMIN_16." [".$row['stadions_name']."]')\"/></form></td>";
