...
|
|		$Source: ../e107_plugins/sport_league_e107/admin/admin_game_config.php $
|		$Revision: 0.87 $
|		$Date: 2011/09/26 $
|		$Author: ***RuSsE*** $
+---------------------------------------------------------------+
...
$text .= "<table style='width:96%' class='fborder' cellspacing='0' cellpadding='0'>
	<tr>
		<td class='forumheader'><div style='cursor:pointer' onclick=\"expandit('exp_infos')\">".LAN_LEAGUE_GAME_ADMIN_26."</div>
<div id='exp_infos' style='".$expand_autohide."'>".LAN_LEAGUE_GAME_ADMIN_27."</div></td>
	</tr>
	<tr>
		<td>
...
$text.= get_team_date($game['id'], $game['home_team_Name'], $game['home_id'],$T);	
$text.="</td>
				<td align='center' width='50%' valign='top'>";
$text.= get_team_date($game['id'], $game['gast_team_Name'], $game['gast_id'],$T);					
$text.="</td>
			</tr>
		</table>
	</td>
...
////------------------------------------------------------------------------------
function get_team_date($game_id, $team_Name, $team_id,$T)
	{
require_once("../../../class2.php");

$position[0]=LAN_LEAGUE_GAME_ADMIN_28;
$position[1]=LAN_LEAGUE_GAME_ADMIN_22;
$position[2]=LAN_LEAGUE_GAME_ADMIN_23;
$position[3]=LAN_LEAGUE_GAME_ADMIN_24;
$position[4]=LAN_LEAGUE_GAME_ADMIN_25;
$position[5]=LAN_LEAGUE_GAME_ADMIN_25b;
$position[6]=LAN_LEAGUE_GAME_ADMIN_25c;
...
$INHALT_TEXT ="	
				<table style='width:100%' class='fborder' cellspacing='0' cellpadding='0'>
					<tr>
						<td class='fcaption'>".LAN_LEAGUE_GAME_ADMIN_1." <b>".$team_Name."</b> <a href='admin_game_anw.php?".$game_id.".".$team_id.".".$T."' title='".LAN_LEAGUE_GAME_ADMIN_1." <b>".$team_Name."</b> ".LAN_LEAGUE_GAME_ADMIN_17."'>".ADMIN_EDIT_ICON."</a></td>
					</tr>
					<tr>
						<td>
						<table style='width:100%' class='fborder' cellspacing='0' cellpadding='0'>
...
///////////////////////////////////
	...
	$INHALT_TEXT .= "</table>
					...
					<tr>
						<td class='fcaption'>".LAN_LEAGUE_GAME_ADMIN_2." <b>".$team_Name."</b> <a href='".e_PLUGIN."sport_league_e107/admin/admin_game_tore.php?".$game_id.".".$team_id.".".$T."' title='".LAN_LEAGUE_GAME_ADMIN_2." <b>".$team_Name."</b> ".LAN_LEAGUE_GAME_ADMIN_17."'>".ADMIN_EDIT_ICON."</a></td>
					</tr>
					<tr>
						<td>";					
////////-----------------------Spieler Daten --------------------------------
...
$INHALT_TEXT.="</table>
					...
					<tr>";					
///////////////// Strafen !!! ////////////////////////
$INHALT_TEXT.="<td class='fcaption'>".LAN_LEAGUE_GAME_ADMIN_3." <b>".$team_Name."</b> <a href='".e_PLUGIN."sport_league_e107/admin/admin_game_foults.php?".$game_id.".".$team_id.".".$T."' title='".LAN_LEAGUE_GAME_ADMIN_3." <b>".$team_Name."</b> ".LAN_LEAGUE_GAME_ADMIN_17."'>".ADMIN_EDIT_ICON."</a></td>
					</tr>
					<tr>
						<td>
						<table style='width:100%' class='fborder' cellspacing='0' cellpadding='0'>
