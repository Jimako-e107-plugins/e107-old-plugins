...
$CALENDAR_TIME_TABLE = "
<table cellpadding='0' cellspacing='1' class='fborder' style='width:100%; font-size: 100%;'>
<tr>
...
$EVENT_EVENTLIST_TABLE_START = "<table style='width:100%; font-size: 100%;' class='fborder'>{EVENTLIST_CAPTION}";
...
$EVENT_ARCHIVE_TABLE_START = "<br /><table style='width:100%; font-size: 80%;' class='fborder'>{EVENTARCHIVE_CAPTION}";
$EVENT_ARCHIVE_TABLE = "
<tr>
...
// EVENT SHOW EVENT ------------------------------------------------------------
$EVENT_EVENT_TABLE_START = "<table style='width:100%; font-size: 100%;' class='fborder' cellspacing='0' cellpadding='0'>";
...
<tr>
	<td >
		...
		<div id='{EVENT_ID}' style='display:{EVENT_DISPLAYSTYLE}; padding-top:10px; padding-bottom:10px; text-align:left;'>
			<table style='width:100%; font-size: 100%;'  cellspacing='0' cellpadding='0'>
...
$CALENDAR_SHOWEVENT = "<table cellspacing='0' cellpadding='0' style='width:100%; font-size: 100%;'><tr>{CALENDAR_CALENDAR_RECENT_ICON}<td style='vertical-align:top; width:10px;'>{SHOWEVENT_IMAGE}</td><td style='vertical-align:top; width:2%;'>{SHOWEVENT_INDICAT}</td><td style='vertical-align:top;'>{SHOWEVENT_HEADING}</td></tr>\n</table>";
...
<table cellpadding='0' cellspacing='1' class='fborder' style='background-color:#DDDDDD; width:100%; font-size: 100%;'>";
...
$CALENDAR_CALENDAR_HEADER = "<td class='fcaption' style='z-index: -1; background-color:#000; color:#FFF; width:90px; height:50px; text-align:center; vertical-align:middle;'>{CALENDAR_CALENDAR_HEADER_DAY}</td>";
...
<td class='forumheader3' style='vertical-align:top; width:14%; height:120px; padding-bottom:0px;padding-right:0px; margin-right:0px; padding:2px;'>
...
<td class='forumheader3' style='z-index: 1;vertical-align:top; width:14%; height:120px; padding-bottom:0px;padding-right:0px; margin-right:0px; padding:2px;'>
...
<td class='forumheader2' style='z-index: 1;vertical-align:top; width:14%; height:120px;padding-bottom:0px;padding-right:0px; margin-right:0px; padding:2px;'>
...
$CALENDAR_MENU_TABLE_START =   "<table cellpadding='0' cellspacing='1' style='width:100%; font-size: 100%;' class='fborder'>";


$CALENDAR_MENU_HEADER_FRONT = "<td class='fcaption' style='width:14.28%; text-align:center; padding:2px; vertical-align:middle; font-size: 25px;'>";
$CALENDAR_MENU_HEADER_BACK = "</td>";

//today, no events
$CALENDAR_MENU_DAY_START['1'] = "<td class='fcaption' style='width:14.28%; padding:2px; text-align:center; font-size: 80%;font-weight:bold;'>";

// no events and not today
$CALENDAR_MENU_DAY_START['2'] = "<td class='forumheader' style='width:14.28%; padding:2px; text-align:center; font-size: 80%;font-weight:bold;'>";

//day has events - same whether its today or not
$CALENDAR_MENU_DAY_START['3'] = "<td class='forumheader' style='width:14.28%; padding:0px; text-align:center; font-size: 80%;font-weight:bold;'>";
$CALENDAR_MENU_DAY_START['4'] = "<td class='forumheader2' style='width:14.28%; padding:2px; text-align:center; font-size: 80%;font-weight:bold;'>";
$CALENDAR_MENU_DAY_START['5'] = "<td class='forumheader3' style='width:14.28%; padding:0px; text-align:center; font-size: 80%;font-weight:bold;'>";
...
$BIGCALENDAR_MENU_TABLE_START =   "<table cellpadding='0' cellspacing='1' style='width:100%; font-size: 80%;' class='fborder'>";
...
$BIGCALENDAR_MENU_HEADER_FRONT = "<td class='fcaption' style='text-align:center; padding:2px; vertical-align:middle; font-size: 25px;'>";
...
//today, no events
$BIGCALENDAR_MENU_DAY_START['1'] = "<td class='fcaption' style='height:120px;width:14.28%;padding:2px;text-align:left;vertical-align:top;font-size: 80%;font-weight:bold;'>";

// no events and not today
$BIGCALENDAR_MENU_DAY_START['2'] = "<td class='forumheader2' style='height:120px;width:14.28%;padding:2px;text-align:left;vertical-align:top;font-size: 80%;font-weight:bold;'>";

//day has events - same whether its today or not
$BIGCALENDAR_MENU_DAY_START['3'] = "<td class='fcaption' style='height: 120px;width:14.28%; padding:2px; text-align:left; vertical-align:top; font-size: 80%;font-weight:bold;'>";
$BIGCALENDAR_MENU_DAY_START['4'] = "<td class='indent' style='height: 120px;width:14.28%; padding:2px; text-align:left; vertical-align:top; font-size: 80%;font-weight:bold;'>";
// day has events, one which is recently added/updated
$BIGCALENDAR_MENU_DAY_START['5'] = "<td class='forumheader' style='height: 7px;width:14.28%; padding:2px; text-align:left; vertical-align:top; font-size: 80%;font-weight:bold; '>";
$BIGCALENDAR_MENU_DAY_START['6'] = "<td class='forumheader' style='height: 120px;width:14.28%; padding:2px; text-align:left; vertical-align:top; font-size: 80%;font-weight:bold;'>";
// Example highlight using background colour:
$BIGCALENDAR_MENU_DAY_START['5'] = "<td class='forumheader2' style='height: 120px; width:14.28%; padding:2px; text-align:left; vertical-align:top; font-size: 80%;font-weight:bold;'>";
$BIGCALENDAR_MENU_DAY_START['6'] = "<td class='forumheader' style='color: #fff; height: 120px; width:14.28%; padding:2px; text-align:left; vertical-align:top; font-size: 80%;font-weight:bold;'>";
