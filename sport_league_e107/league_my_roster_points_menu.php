...
if($pref['sport_league_menu_scorer_first']=="0")
	...
	$text .="	<tr>
							<td style='vertical-align:top;padding:0px;padding-bottom:4px;'>
								<table cellpadding='0' cellspacing='0' width='100%'>
								<tr>
									<td class='' style='width:30%;border:0px;text-align:center;vertical-align:top;font-size:11px;padding:0px;'><a href='".e_PLUGIN."sport_league_e107/profil.php?player_id=".$player[0]['roster_id']."' title='".$player[0]['players_name']."'><img border='0' src='".e_PLUGIN."sport_league_e107/fotos/".$player[0]['players_image']."' height='100px'></a></td>
...
$text .="<td class='forumheader3' style='padding:1px;border-top:0px;border-left:0px;font-size:12px;text-align:left;'>";
...
$text .="<td class='forumheader3' style='padding:1px;border-top:0px;font-size:11px;text-align:center;'>".$player[$i]['Points']."</td>";
$text .="</tr>";
		}																	
$text .="				</table>
							</td>
...
$title = "".LAN_LEAGUE_ROSTER_POINTS_MENU_01." ".$team_Name."";
