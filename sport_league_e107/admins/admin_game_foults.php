...
if(IsSet($_POST['submitit'])){
	if($_POST['time']=="")
			...
			if($_POST['tor']< 1)
					...
					$INPUTSTRING1="0, '".$_POST['foult_value']."', '".$_POST['Saison_ID']."', '".$_POST['Game_ID']."', '".$_POST['tor']."', '".$_POST['Team_ID']."',  '".$_POST['time']."'";
...
$text.="<div style='width:100%; text-align:center;'><b>".LAN_LEAGUE_GAME_FOULT_ADMIN_13."</b><br/><br/><form action='".e_SELF."' method='post' id='tor'>
...
$text.="<br/><br/><b>".LAN_LEAGUE_GAME_FOULT_ADMIN_14."</b><br/><br/><table style='width:1000px' class='fborder' cellspacing='0' cellpadding='0'>
	<tr>
