...
if($_GET['ID']){$game=$_GET['ID'];}else{$game=$_POST['Game_ID'];}
if($_GET['Team_ID']){$team=$_GET['Team_ID'];}else{$team=$_POST['Team_ID'];}
...
if(IsSet($_POST['submitit'])){
	if($_POST['time']=="")
			...
			if($_POST['tor']< 1)
					...
					$INPUTSTRING1="0, '1', '".$_POST['Saison_ID']."', '".$_POST['Game_ID']."', '".$_POST['tor']."', '".$_POST['Team_ID']."',  '".$_POST['time']."'";
					$sql -> db_Insert("league_points", $INPUTSTRING1);
					if($_POST['ass1']!="0")
						{
						$INPUTSTRING2= "0, '2', '".$_POST['Saison_ID']."', '".$_POST['Game_ID']."', '".$_POST['ass1']."', '".$_POST['Team_ID']."',  '".$_POST['time']."'";				
						$sql -> db_Insert("league_points", $INPUTSTRING2);
						}
					if($_POST['ass2']!="0")
						{
						$INPUTSTRING3 ="0, '2', '".$_POST['Saison_ID']."', '".$_POST['Game_ID']."', '".$_POST['ass2']."', '".$_POST['Team_ID']."',  '".$_POST['time']."'";
...
$text .= "<div style='width:100%;text-align:center;'><b>".LAN_LEAGUE_GAME_TOR_ADMIN_13."</b><br/><br/><form action='".e_SELF."' method='post' id='tor'>
<table style='width:1000px;' class='fborder' cellspacing='0' cellpadding='0'>
	<tr>
	...
	<tr>
		<td class='forumheader'><input name='time' type='textarea' size='6' maxlength='5'>
		</td>
...
for($i=0; $i < $torcount; $i++)
		...
		<td class='fcaption' style='text-align:center;'> <form action='".e_SELF."' method='post' id='edit'>
			<input type='hidden' name='Saison_ID' value='".$saison."'>
			<input type='hidden' name='Team_ID' value='".$team."'>
...
$text.="</table><br/><br/>
<form action='admin_game_config.php?list.".$game."' method='post' id='back'>
