...
$MYTEXT .= "<div style='width:100%; text-align: center;'>".$LINKS_TEXT."<br/><table style='width:100%' class='fborder' cellspacing='0' cellpadding='0'>";
$MYTEXT .="
	  <tr>
		<td class='fcaption' style='text-align: center;'><b>".LAN_LEAGUE_GAMES_01."</b></td>
		<td class='fcaption' style='text-align: left;'><b>".LAN_LEAGUE_GAMES_02."</b></td>
		<td class='fcaption' style='text-align: center;' colspan='3'><b>".LAN_LEAGUE_GAMES_03."</b></td>
		<td class='fcaption' style='text-align: center; width: 10%;'><b>".LAN_LEAGUE_GAMES_04."</b></td>
		<td class='fcaption' style='text-align: center; width: 5%;'><b>".LAN_LEAGUE_GAMES_05."</b></td>
	</tr>
	<tr>
	</tr>";	
   for($i=$von;$i< $bis; $i++) 	
...
if($wert[25][$i]=='1'&&$team=='*'||$wert[24][$i]=='1'&&$team=='*'||$wert[3][$i]==$team&&$team!='*'){$TABELLESTYLE ="forumheader";}else{$TABELLESTYLE ="forumheader3";}			
		...
		$MYTEXT .="&nbsp;<a href='".e_PLUGIN."sport_league_e107/league_stats.php?team_a=".$wert[3][$i]."&&team_b=".$wert[4][$i]."' title='Mannschaften vergleichen'>vs.</a>&nbsp;</td>";
		...
		if($wert[8][$i]=='1')
		  {$MYTEXT .=LAN_LEAGUE_GAMES_45."</td>";}
		else{$MYTEXT .="</td>";}			
		$MYTEXT .="<td class='".$TABELLESTYLE."' style='text-align:center;padding:4px;'>";
		if($wert[21][$i]!= '0'&& $wert[9][$i]==true)
		  {$MYTEXT .="<a href='http:".e_BASE."news.php?extend.".$wert[21][$i]."' title='".LAN_LEAGUE_GAMES_11."'><img border='0' src='images/system/news.png'></a><a target='_blank' href='game_report.php?game_id=".$wert[0][$i]."' title='".LAN_LEAGUE_GAMES_12."'><img border='0' src='images/system/help.png' title='".LAN_LEAGUE_GAMES_12."'></a>";}
		else if($wert[9][$i]==true){$MYTEXT .="<img border='0' src='images/system/nonews.png' title='".LAN_LEAGUE_GAMES_13."'><a target='_blank' href='game_report.php?game_id=".$wert[0][$i]."' title='".LAN_LEAGUE_GAMES_12."'><img border='0' src='images/system/help.png' title='".LAN_LEAGUE_GAMES_12."'></a>";}
		    else{$MYTEXT .="&nbsp;";}	
