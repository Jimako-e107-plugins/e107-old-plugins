...
$TEMPL="".e_THEME."".$_GET['Template']."/style.css";
...
if($TEMPL){
		$text ="<link rel='stylesheet' type='text/css' media='screen' href='".$TEMPL."'>";
		$templ=$_GET['Template'];
		}
...
$text .= "<div style='width:100%; text-align: center;'><table style='width:100%' class='fborder' cellspacing='0' cellpadding='0'>";
 ...
 $text .= "	<tr>
  ...
  if($player[$i][7]=='1')
     	{	
     	$text .=player_row($player[$i][5], $player[$i][0], $player[$i][17], $player[$i][27], $player[$i][26], $player[$i][30], $player[$i][31], $TEMPL);
     	}
   else{continue;}
    } 	     	
  $text .= "<tr>                                                         
...
////////////////////////  Functionen ////////////////////////////////////////////////////////////////////////////
function player_row($NUMMBER,$PLAYERID,$PLAYERNAME,$PLAYERFIELD1,$PLAYERFIELD2,$PLAYERPOINTS,$PLAYERPENALTY,$TEMPLATE)
	{
global $templ;	
//if($TEMPLATE){
				$ROWTEXT ="<link rel='stylesheet' type='text/css' media='screen' href='".$TEMPL."'>";
//				}
//else{$ROWTEXT ="<link rel='stylesheet' type='text/css' media='screen' href='".THEME."style.css'>";}		
		
 	$ROWTEXT .= "<tr>"; 
 	$ROWTEXT .= "<td class='forumheader3' style='width:5%; text-align:right;'><b>&nbsp;".$NUMMBER."</b></td>"; 
 	$ROWTEXT .= "<td class='forumheader3'><b><a href='profil.php?player_id=".$PLAYERID."&Template=".$templ."'>".$PLAYERNAME."</a></b></td>"; 
