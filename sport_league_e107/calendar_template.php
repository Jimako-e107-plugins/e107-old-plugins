...
//today, no events
$BIGCALENDAR_MENU_DAY_START['1'] = "<td class='fcaption' style='height: 70px;width:14.28%; padding:2px; text-align:left; vertical-align:top; font-size: 80%;font-weight:bold;'>";

// no events and not today
$BIGCALENDAR_MENU_DAY_START['2'] = "<td class='forumheader2' style='height: 70px;width:14.28%; padding:2px; text-align:left; vertical-align:top; font-size: 80%;font-weight:bold;'>";

//day has events - same whether its today or not
$BIGCALENDAR_MENU_DAY_START['3'] = "<td class='fcaption' style='height: 70px;width:14.28%; padding:2px; text-align:left; vertical-align:top; font-size: 80%;font-weight:bold;'>";
$BIGCALENDAR_MENU_DAY_START['4'] = "<td class='indent' style='height: 70px;width:14.28%; padding:2px; text-align:left; vertical-align:top; font-size: 80%;font-weight:bold;'>";
...
$BIGCALENDAR_MENU_DAY_START['6'] = "<td class='forumheader' style='height: 70px;width:14.28%; padding:2px; text-align:left; vertical-align:top; font-size: 80%;font-weight:bold;'>";
// Example highlight using background colour:
$BIGCALENDAR_MENU_DAY_START['5'] = "<td class='forumheader2' style='height: 70px; width:14.28%; padding:2px; text-align:left; vertical-align:top; font-size: 80%;font-weight:bold;'>";
$BIGCALENDAR_MENU_DAY_START['6'] = "<td class='forumheader' style='color: #fff; height: 70px; width:14.28%; padding:2px; text-align:left; vertical-align:top; font-size: 80%;font-weight:bold;'>";
