...
/*
+---------------------------------------------------------------+
|  e107 website system  liga_table.php   liga_calendar.php
|                             
|		$Revision: 0.84 $
|		$Date: 2010/02/04 $
|		$Author: ***RuSsE*** $
...
$text="<tr>
			<td style='text-align:right;background:#b80000 url(images/navbar_bg.png) repeat-x;width:100%;height:100px;color:#ffffff;font-weight:bold;padding:15px;'>
				<div style='color:#fff;text-align:center;background: url(images/back2.png);width:274px;height:66px;'><a href='index.php'>Zurück</a></div>
			</td>
		</tr>
		<tr>
			<td style='background:#101010 url(images/body_bg.png) repeat-x;width:100%;height:text-align:center;vertical-align:top;color:#ffffff;font-weight:bold;padding:20px;'>";
global $ecal_dir, $tp;
require_once("../functionen.php");

//if (is_readable(THEME."m_calendar_template.php"))
//{
// require(THEME."/m_calendar_template.php");
//}
//else
//{
 require("m_calendar_template.php");
//}
...
for($i=0; $i <= $gamescount ; $i++)
	...
	if($termine[$i]['myteam_who']!=0)
		...
		if($termine[$i]['games_enable']==1)
			...
			$RESULT_TEXT="<tr><td style=\'font-size:50px;text-align:right;background:transparent;\'><b>".$termine[$i]['games_goals_home']."<\/b><\/td><td style=\'font-size:50px;text-align:center;background:transparent;\'>&nbsp;:&nbsp;<\/td><td style=\'font-size:50px;text-align:left;background:transparent;\'><b>".$termine[$i]['games_goals_gast']."<\/b> ".$RT."<\/td><\/tr>";
			}
		...
		if($termine[$i]['myteam_who']==1)
			{
			$Link_ico = "<img style='width:70px;border:0px;' src='".e_PLUGIN."sport_league_e107/logos/".$termine[$i]['gast_image']."' alt='' />";
			$GAME[$cc]['wo']=1;
			$heimspiele++;
		...
		elseif($termine[$i]['myteam_who']==2)
				{		
			$Link_ico = "<img style='width:70px;border:0px;' src='".e_PLUGIN."sport_league_e107/logos/".$termine[$i]['home_image']."' alt=''/>";
			$GAME[$cc]['wo']=2;
			$auswaetrsspiele++;
			if($termine[$i]['games_goals_home']>$termine[$i]['games_goals_gast'] && $termine[$i]['games_enable'])
				{
		...
		$termiene_insgesammt++;														
		$Link_table="<table style='padding:0px;width:100%;background:transparent;font-size:120%;' cellspacing='0' cellpadding='0'>
								 	<tr>
								 		<td style='text-align:center;font-size:100%'>
								 			<a href='".$Link."' > ".$Link_ico." <br/>
...
///////////////////////////////////============================================================================
$kalender_title ="<table style='width:100%;height:70px;border:0px;font-size:150%' cellpadding='0' cellspacing='0'>
	<tr>
...
$inhalt_text.="<table style='padding:0px;width:100%;background:transparent;font-size:120%;' cellspacing='0' cellpadding='0'>
								<tr>
...
$ausgabe="<table style='width:100%;border:0px;font-size:100%' cellpadding='0' cellspacing='0'>
						<tr>
